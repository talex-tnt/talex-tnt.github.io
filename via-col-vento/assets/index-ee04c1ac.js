...
`,Routes=()=>{const e="hid"in navigator||OVERRIDE_HID_CHECK,t=useAppSelector(getRenderMode),o=reactExports.useMemo(()=>PANES.map(a=>jsx(Route,{component:a.component,path:a.path},a.key)),[]),n="/via-col-vento/",r=t==="2D"?CanvasRouter:CanvasRouter$1,s=reactExports.useState({clearTestKeys:()=>{}});return jsx(Fragment,{children:jsxs(TestContext.Provider,{value:s,children:[jsx(GlobalStyle,{}),e&&jsx(UnconnectedGlobalMenu,{}),jsxs(Router,{base:n,children:[jsx(r,{}),jsx(Home,{hasHIDSupport:e,children:o})]})]})})},Root=()=>jsx(Provider_default,{store,children:jsx(Routes,{})}),elem=document.getElementById("root");elem&&(createRoot(elem).render(jsx(Root,{})),document.documentElement.dataset.themeMode=getThemeModeFromStore(),updateCSSVariables(getThemeNameFromStore()));
