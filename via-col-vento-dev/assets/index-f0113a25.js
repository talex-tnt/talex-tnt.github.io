...
`,title$3="Keymap",component$3=e=>jsx(FontAwesomeIcon,{icon:faBook}),MessageDialogContainer=styled.dialog`
  padding: 0;
  border-width: 0;
...
`,Controls=styled.div`
  ...
  align-items: center;
  gap: 1rem;
`,MessageDialog=e=>{const t=reactExports.useRef(null),o=reactExports.useCallback(n=>{t.current&&t.current.close(),n&&n(),e.onClose&&e.onClose()},[t.current,e.onClose]);return reactExports.useEffect(()=>(t.current&&(e.isOpen?t.current.showModal():t.current.close()),()=>{o()}),[e.isOpen]),jsx(MessageDialogContainer,{ref:t,children:jsxs(ModalContainer,{children:[jsx(PromptText,{children:e.children}),jsxs(Controls,{children:[jsx(PrimaryAccentButton,{onClick:()=>o(e.onConfirm),children:"Confirm"}),e.onCancel&&jsx(AccentButton,{onClick:()=>o(e.onCancel),children:"Cancel"})]})]})})},KeycapContainer=styled.div`
  position: absolute;
  left: 0;
  top: 0;
  width: 52px;
...
`,Container$c=styled.div`
  ...
  flex-direction: column;
  padding: 0 12px;
`,renderEncoderError=()=>jsx(ErrorMessage,{children:"Your current firmware does not support rotary encoders. Install the latest firmware for your device."}),Pane$7=()=>{const[e,t]=reactExports.useState(),[o,n]=reactExports.useState(),r=useAppSelector(getSelectedKey),s=useAppDispatch(),i=useAppSelector(getSelectedKeyDefinitions),a=useAppSelector(K=>getSelectedKeymap(K)||[]),c=useAppSelector(getSelectedLayerIndex),l=useAppSelector(getSelectedConnectedDevice),d=useAppSelector(getSelectedKeyboardAPI),u=a[r??-1],_=i[r??-1],C=!!_&&_.col!==-1&&_.row!==-1,h=(K,y)=>{if(d&&r!==null&&_&&_.ei!==void 0){const g=+_.ei;switch(K){case"ccw":{d.setEncoderValue(c,g,!1,y),n(y);break}case"cw":{d.setEncoderValue(c,g,!0,y),t(y);break}case"click":{s(updateKey(r,y));break}}}},p=async(K,y,g)=>{const m=await g.getEncoderValue(K,y,!0),S=await g.getEncoderValue(K,y,!1);t(m),n(S)};return reactExports.useEffect(()=>{if(l&&l.protocol>=10&&_!==void 0&&_.ei!==void 0&&d){const K=+_.ei;p(c,K,d)}},[_,l,c]),_===void 0||l&&l.protocol<10||o===void 0||e===void 0?jsx(SpanOverflowCell,{children:renderEncoderError()}):jsx(SpanOverflowCell,{children:jsx(Encoder,{children:jsxs(Container$c,{children:[jsxs(ControlRow,{children:[jsx(Label$1,{children:"Rotate Counterclockwise"}),jsx(Detail,{children:jsx(PelpiKeycodeInput,{value:o,meta:{},setValue:K=>h("ccw",K)})})]}),jsxs(ControlRow,{children:[jsx(Label$1,{children:"Rotate Clockwise"}),jsx(Detail,{children:jsx(PelpiKeycodeInput,{value:e,meta:{},setValue:K=>h("cw",K)})})]}),C&&jsxs(ControlRow,{children:[jsx(Label$1,{children:"Press Encoder"}),jsx(Detail,{children:jsx(PelpiKeycodeInput,{value:u,meta:{},setValue:K=>h("click",K)})})]})]})})})},KeycodeList=styled.div`
  display: grid;
...
`;function keyCodeToObject(e,t){return{...e,[t.code]:t}}const generateKeycodeCategories=(e,t=16)=>getKeycodes(t).concat(getOtherMenu(e)),maybeFilter=(e,t)=>e?()=>!0:t,Pane$6=()=>{const e=useAppSelector(getSelectedKey),t=useAppDispatch(),o=useAppSelector(getSelectedKeyDefinitions);return reactExports.useEffect(()=>()=>{t(updateSelectedKey(null))},[]),e!==null&&o[e].ei!==void 0?jsx(Pane$7,{}):jsx(KeycodePane,{})},allKeycodesId="all_keycodes",KeycodePane=()=>{const e=useAppDispatch(),t=useAppSelector(E=>E.macros),o=useAppSelector(getSelectedDefinition),n=useAppSelector(getSelectedConnectedDevice),r=useAppSelector(getSelectedKeymap),s=useAppSelector(getSelectedKey),i=useAppSelector(getDisableFastRemap),a=useAppSelector(getSelectedKeyDefinitions),{basicKeyToByte:c}=useAppSelector(getBasicKeyToByte),l=useAppSelector(getMacroCount),d=reactExports.useMemo(()=>generateKeycodeCategories(c,l),[c,l]);if(!o||!n||!r)return null;const[u,_]=reactExports.useState(allKeycodesId),[C,h]=reactExports.useState(null),[p,K]=reactExports.useState(!1),[y,g]=reactExports.useState(""),[m,S]=reactExports.useState(null),M=()=>{if(dist.isVIADefinitionV3(o))return L(o);const{lighting:E,customKeycodes:B}=o,{keycodes:v}=dist.getLightingDefinition(E);return d.filter(maybeFilter(v===dist.KeycodeType.QMK,({id:T})=>T!=="qmk_lighting")).filter(maybeFilter(v===dist.KeycodeType.WT,({id:T})=>T!=="lighting")).filter(maybeFilter(typeof B<"u",({id:T})=>T!=="custom"))},L=E=>{const v=["default",...E.keycodes||[]].flatMap(T=>categoriesForKeycodeModule(T));return(o.customKeycodes||[]).length!==0&&v.push("custom"),d.filter(T=>v.includes(T.id))},x=()=>jsx(ErrorMessage,{children:"Your current firmware does not support macros. Install the latest firmware for your device."}),b=()=>jsx(MenuContainer$4,{children:M().map(({id:E,label:B})=>jsx(SubmenuRow,{$selected:E===u,onClick:()=>_(u===E?allKeycodesId:E),children:B},E))}),D=()=>(e(disableGlobalHotKeys()),jsx(KeycodeModal,{defaultValue:s!==null?r[s]:void 0,onExit:()=>{e(enableGlobalHotKeys()),K(!1)},onConfirm:E=>{e(enableGlobalHotKeys()),O(E),K(!1)}})),O=E=>{s!==null&&(e(updateKey(s,E)),e(updateSelectedKey(i||!a?null:getNextKey(s,a))))},j=(E,B)=>{if(E=="text")K(!0);else if(keycodeInMaster(E,c)){const v=getByteForCode(E,c);i?S(v):O(v)}},k=(E,B,v)=>{const{code:T,title:N,name:F}=E;return jsxs(Keycode,{disabled:!v||!keycodeInMaster(T,c)&&T!="text",onClick:()=>{v&&j(T)},onMouseOver:()=>h(N?`${T}: ${N}`:T),onMouseOut:()=>h(null),children:[jsx(KeycodeContent,{children:F}),jsx(TooltipContainer,{$rotate:0,children:jsx(Keycap2DTooltip,{children:N?`${T}: ${N}`:`${T}`})})]},T)},A=()=>jsx(CustomKeycode,{onClick:()=>s!==null&&j("text"),onMouseOver:()=>h("Enter any QMK Keycode"),onMouseOut:()=>h(null),children:"Any"},"customKeycode"),R=(E,B,v=null)=>{const T=E.map((N,F)=>k(N,F,!!v));switch(B){case"macro":return t.isFeatureSupported?jsx(KeycodeList,{children:T}):x();case"special":return jsx(KeycodeList,{children:[A()].concat(T)});case"shifted":return jsx(KeycodeList,{children:T});case"custom":return!dist.isVIADefinitionV2(o)&&!dist.isVIADefinitionV3(o)||!o.customKeycodes?null:jsx(KeycodeList,{children:o.customKeycodes.map((N,F)=>k({...N,code:`CUSTOM(${F})`},F,!!v))});default:return jsx(KeycodeList,{children:T})}},I=reactExports.useMemo(()=>{var T;const E=d.reduce((N,{keycodes:F})=>[...N,...F],[]),B=Object.values(E.reduce(keyCodeToObject,{})),v=(T=d.find(({id:N})=>N===u))==null?void 0:T.keycodes;return u===allKeycodesId?B:v},[d,u]),P=()=>{typeof m=="number"&&O(m),S(null)},w=()=>{S(null)},U=`Search among ${I.length} keycodes`,$="10px 10px 10px 30px",Y=I.filter(E=>{const{name:B,code:v,title:T}=E;return(B==null?void 0:B.toLowerCase().includes(y.toLowerCase()))||(v==null?void 0:v.toLowerCase().includes(y.toLowerCase()))||(T==null?void 0:T.toLowerCase().includes(y.toLowerCase()))});return jsxs(Fragment,{children:[jsx(MessageDialog,{isOpen:m!==null,onConfirm:P,onCancel:w,children:"Save on the keyboard?"}),jsx(SubmenuOverflowCell,{children:b()}),jsxs(OverflowCell,{children:[jsx(TextInput,{$width:"50%",$margin:$,type:"text",placeholder:U,onChange:E=>g(E.target.value),value:y}),jsx(IconButtonUnfilledContainer,{onClick:()=>{g("")},disabled:y.length===0,style:{borderRight:"1px solid var(--color_accent)"},children:jsx(FontAwesomeIcon,{size:"sm",color:"var(--color_accent)",icon:faXmark})}),jsx(KeycodeContainer,{children:R(Y,u,s)}),jsx(KeycodeDesc,{children:C}),p&&D()]})]})},Icon$5=component$3,Title$5=title$3,Keycode$1=Object.freeze(Object.defineProperty({__proto__:null,Icon:Icon$5,KeycodePane,Pane:Pane$6,Title:Title$5},Symbol.toStringTag,{value:"Module"})),LightingControl=e=>{const t=useAppDispatch(),o=useAppSelector(getSelectedLightingData),n=useAppSelector(getSelectedDefinition),[r,s,i]=e.meta,a=o&&o[r];if(!a||!n)return null;const c=typeof s=="string"?s:s(e);switch(i.type){case"slider":return jsxs(ControlRow,{children:[jsx(Label$1,{children:c}),jsx(Detail,{children:jsx(AccentSlider,{isChecked:!!a[0],onChange:l=>t(updateBacklightValue(r,+l))})})]});case"range":return jsxs(ControlRow,{children:[jsx(Label$1,{children:c}),jsx(Detail,{children:jsx(AccentRange,{max:i.max,min:i.min,defaultValue:a[0],onChange:l=>t(updateBacklightValue(r,l))})})]});case"color":return jsxs(ControlRow,{children:[jsx(Label$1,{children:c}),jsx(Detail,{children:jsx(ArrayColorPicker,{color:a,setColor:(l,d)=>t(updateBacklightValue(r,l,d))})})]});case"select":{const l=i.getOptions(n).map((d,u)=>({value:u,label:d}));return jsxs(ControlRow,{children:[jsx(Label$1,{children:c}),jsx(Detail,{children:jsx(AccentSelect,{onChange:d=>{d&&t(updateBacklightValue(r,+d.value))},options:l,defaultValue:l.find(d=>a[0]===d.value)})})]})}case"row_col":return jsxs(ControlRow,{children:[jsx(Label$1,{children:c}),jsx(Detail,{children:jsx(AccentSlider,{isChecked:a[0]!==255,onChange:l=>{t(updateBacklightValue(r,...l?[254,254]:[255,255]))}})})]})}return null},BacklightControls=[[dist.LightingValue.BACKLIGHT_BRIGHTNESS,"Brightness",{type:"range",min:0,max:255}],[dist.LightingValue.BACKLIGHT_EFFECT,"Effect",{type:"select",getOptions:e=>dist.isVIADefinitionV2(e)&&dist.getLightingDefinition(e.lighting).effects.map(([t])=>t)}],[dist.LightingValue.BACKLIGHT_EFFECT_SPEED,"Effect Speed",{type:"range",min:0,max:3}]],UnderglowControls=[[dist.LightingValue.QMK_RGBLIGHT_BRIGHTNESS,"Underglow Brightness",{type:"range",min:0,max:255}],[dist.LightingValue.QMK_RGBLIGHT_EFFECT,"Underglow Effect",{type:"select",getOptions:e=>dist.isVIADefinitionV2(e)&&dist.getLightingDefinition(e.lighting).underglowEffects.map(([t])=>t)}],[dist.LightingValue.QMK_RGBLIGHT_EFFECT_SPEED,"Underglow Effect Speed",{type:"range",min:0,max:3}]],GeneralPane=()=>{const e=useAppDispatch(),t=useAppSelector(getSelectedLightingData),o=useAppSelector(getSelectedDefinition);if(!t)return null;if(!dist.isVIADefinitionV2(o))throw new Error("This lighting component is only compatible with v2 definitions");const n=dist.getLightingDefinition(o.lighting),{supportedLightingValues:r}=n;if(n.supportedLightingValues.length!==0){const s=n.effects.map(([C,h])=>h),i=n.underglowEffects.map(([C,h])=>h),a=t[dist.LightingValue.BACKLIGHT_EFFECT],c=t[dist.LightingValue.QMK_RGBLIGHT_EFFECT],l=a&&s[a[0]]||0,d=c&&i[c[0]]===1,_=!!t.customColors&&l>2;return jsxs(Fragment,{children:[BacklightControls.filter(C=>r.indexOf(C[0])!==-1).map(C=>jsx(LightingControl,{meta:C})),UnderglowControls.filter(C=>r.indexOf(C[0])!==-1).map(C=>jsx(LightingControl,{meta:C})),new Array(l).fill(1).map((C,h)=>C+h).map(C=>{let h,p;const K=C===1?dist.LightingValue.BACKLIGHT_COLOR_1:dist.LightingValue.BACKLIGHT_COLOR_2,y=t[K];if(_&&t.customColors)[h,p]=[t.customColors[C-1],(g,m)=>e(updateCustomColor(C-1,g,m))];else if(y)[h,p]=[{hue:y[0],sat:y[1]},(g,m)=>e(updateBacklightValue(K,g,m))];else return null;return jsxs(ControlRow,{children:[jsxs(Label$1,{children:["Color ",C]}),jsx(Detail,{children:jsx(ColorPicker,{color:h,setColor:p})})]},C)}),d&&jsx(LightingControl,{meta:[dist.LightingValue.QMK_RGBLIGHT_COLOR,"Underglow Color",{type:"color"}]})]})}return null},LayoutConfigValues=[dist.LightingValue.BACKLIGHT_USE_7U_SPACEBAR,dist.LightingValue.BACKLIGHT_USE_ISO_ENTER,dist.LightingValue.BACKLIGHT_USE_SPLIT_BACKSPACE,dist.LightingValue.BACKLIGHT_USE_SPLIT_LEFT_SHIFT,dist.LightingValue.BACKLIGHT_USE_SPLIT_RIGHT_SHIFT,dist.LightingValue.BACKLIGHT_DISABLE_HHKB_BLOCKER_LEDS],BooleanControls=[[dist.LightingValue.BACKLIGHT_USE_7U_SPACEBAR,"Use 7U Spacebar LEDs"],[dist.LightingValue.BACKLIGHT_USE_ISO_ENTER,"Use ISO Enter LEDs"],[dist.LightingValue.BACKLIGHT_USE_SPLIT_BACKSPACE,"Use Split Backspace LEDs"],[dist.LightingValue.BACKLIGHT_USE_SPLIT_LEFT_SHIFT,"Use Split Left Shift LEDs"],[dist.LightingValue.BACKLIGHT_USE_SPLIT_RIGHT_SHIFT,"Use Split Right Shift LEDs"],[dist.LightingValue.BACKLIGHT_DISABLE_HHKB_BLOCKER_LEDS,"Disable HHKB Blocker LEDs"]],Pane$5=()=>{const e=useAppDispatch(),t=useAppSelector(getSelectedLightingData),o=useAppSelector(getSelectedDefinition);if(!t)return null;if(!dist.isVIADefinitionV2(o))throw new Error("This lighting component is only compatible with v2 definitions");const n=dist.getLightingDefinition(o.lighting);if(n.supportedLightingValues.length!==0){const r=BooleanControls.filter(s=>n.supportedLightingValues.indexOf(s[0])!==-1);return jsx(Fragment,{children:r.map(([s,i])=>{const a=t&&t[s],c=a&&a[0];return jsxs(ControlRow,{children:[jsx(Label$1,{children:i}),jsx(Detail,{children:jsx(AccentSlider,{isChecked:!!c,onChange:l=>e(updateBacklightValue(s,+l))})})]},s)})})}return null},AdvancedLightingValues=[dist.LightingValue.BACKLIGHT_DISABLE_WHEN_USB_SUSPENDED,dist.LightingValue.BACKLIGHT_DISABLE_AFTER_TIMEOUT,dist.LightingValue.BACKLIGHT_CAPS_LOCK_INDICATOR_COLOR,dist.LightingValue.BACKLIGHT_CAPS_LOCK_INDICATOR_ROW_COL,dist.LightingValue.BACKLIGHT_LAYER_1_INDICATOR_COLOR,dist.LightingValue.BACKLIGHT_LAYER_1_INDICATOR_ROW_COL,dist.LightingValue.BACKLIGHT_LAYER_2_INDICATOR_COLOR,dist.LightingValue.BACKLIGHT_LAYER_2_INDICATOR_ROW_COL,dist.LightingValue.BACKLIGHT_LAYER_3_INDICATOR_COLOR,dist.LightingValue.BACKLIGHT_LAYER_3_INDICATOR_ROW_COL],AccentText=styled.span`
  color: var(--color_accent);
...
`,componentJoin=(e,t)=>e.reduce((o,n,r)=>(r&&o.push({...t,key:r.toString()}),o.push(n),o),[]),KeycodeMap=getKeycodes().flatMap(e=>e.keycodes).reduce((e,t)=>({...e,[t.code]:t}),{}),optimizeKeycodeSequence=e=>pipeline(e,convertCharacterTaps,trimLastWait,mergeConsecutiveWaits,foldKeydownKeyupKeys,convertToCharacterStreams),cleanKeycodeSequence=e=>pipeline(e,mergeConsecutiveWaits),MacroRecorder=({selectedMacro:e,setUnsavedMacro:t,saveMacro:o,undoMacro:n,isDelaySupported:r})=>{const[s,i]=reactExports.useState(!0),[a,c]=reactExports.useState(!1),[l,d]=reactExports.useState(!1),[u,_]=reactExports.useState(!!document.fullscreenElement),{smartOptimizeEnabled:C,recordDelaysEnabled:h}=useAppSelector(getMacroEditorSettings),p=useDispatch(),[K,y]=useKeycodeRecorder(a,h),g=reactExports.useRef(null),m=reactExports.useCallback(async A=>{c(A),A?(await navigator.keyboard.lock(),y([]),i(!1),d(!0)):(navigator.keyboard.unlock(),C&&y(optimizeKeycodeSequence(K)),d(!1))},[K,c]),S=reactExports.useCallback(()=>{o(""),i(!0),d(!1)},[y,o]),M=reactExports.useCallback(()=>{n(),y([]),i(!0),d(!1)},[n]);reactExports.useEffect(()=>{i(!0),d(!1),y([])},[e]);const L=()=>[...s?e??[]:K],x=reactExports.useMemo(()=>{let A,R=L();return s||!l||!C?A=R:A=optimizeKeycodeSequence(R),A},[K,s,C,l,e]);reactExports.useEffect(()=>{x&&t(sequenceToExpression(x))},[x]);const b=reactExports.useCallback(()=>{s&&i(!1)},[s]),D=reactExports.useCallback(A=>{const R=L();R.splice(A,1),y(cleanKeycodeSequence(R)),b()},[x,e,K,s]),O=reactExports.useCallback((A,R)=>{const I=L();I.splice(A,1,[RawKeycodeSequenceAction.Delay,R]),y(cleanKeycodeSequence(I)),b()},[x,e,K,s]),j=reactExports.useMemo(()=>componentJoin(x.map(([A,R],I)=>{const P=getSequenceItemComponent(A);return jsx(Deletable,{index:I,deleteItem:D,disabled:a,children:RawKeycodeSequenceAction.Delay!==A?jsx(P,{children:A===RawKeycodeSequenceAction.CharacterStream?componentJoin(String(R).split(" ").map((w,U)=>jsx("span",{children:w},U)),jsx("span",{style:{fontFamily:"fantasy, cursive, monospace"},children:"␣"})):Array.isArray(R)?R.map(w=>getSequenceLabel(KeycodeMap[w])??w).join(" + "):getSequenceLabel(KeycodeMap[R])}):jsx(WaitInput,{index:I,value:Number(R),updateValue:O})},`${I}-${A}`)}),jsx(SequenceLabelSeparator,{})),[x]);reactExports.useEffect(()=>{const A=()=>{_(!!document.fullscreenElement)};return document.documentElement.addEventListener("fullscreenchange",A),()=>{m(!1),document.documentElement.removeEventListener("fullscreenchange",A)}},[_]);const k=reactExports.useCallback(()=>{document.fullscreenElement?document.exitFullscreen&&(m(!1),document.exitFullscreen()):document.documentElement.requestFullscreen()},[m]);return jsxs(Fragment,{children:[jsx(MacroSequenceContainer,{ref:g,$isModified:!s,children:j.length?j:jsx(NoMacroRecorded,{children:"No macro recorded yet..."})}),jsx("div",{style:{border:"none",maxWidth:960,width:"100%",display:"flex",justifyContent:"center",transform:"translate(-0px, -21px)"},children:jsx(MacroEditControls,{isFullscreen:u,isEmpty:!e||!e.length,optimizeRecording:C,recordDelays:h,isRecording:a,addText:()=>{},deleteMacro:S,toggleOptimizeRecording:()=>{p(setMacroEditorSettings({smartOptimizeEnabled:!C}))},toggleRecordDelays:()=>{p(setMacroEditorSettings({recordDelaysEnabled:!h}))},toggleFullscreen:k,undoChanges:M,saveChanges:()=>o(),hasUnsavedChanges:!s,recordingToggleChange:m,isDelaySupported:r})})]})},TextArea=styled.textarea`
  box-sizing: border-box;
  background: var(--bg_control);
  padding: 5px 10px;
...
`,ColumnDiv=styled.div`
  display: flex;
  flex-direction: column;
`;class EncoderModeToggle extends React.Component{constructor(){super(...arguments);f(this,"handleInputChange",o=>{const{enabledModes:n,onChange:r}=this.props,{target:{checked:s,name:i}}=o,a=1<<MODES[i],c=s?n|a:n&~a;r(c)});f(this,"isChecked",o=>(1<<o&this.props.enabledModes)>0)}render(){return jsxs(CenteredColumnDiv,{children:[jsx("h3",{children:"Enabled Encoder Modes:"}),jsx("p",{children:"Only the selected encoder modes will be available on the keyboard"}),jsx(ColumnDiv,{children:Object.entries(MODES).map(([o,n])=>jsxs("label",{htmlFor:MODE_LABELS[o],children:[jsx("input",{name:o,id:MODE_LABELS[o],type:"checkbox",checked:this.isChecked(n),onChange:this.handleInputChange},n),MODE_LABELS[o]]},n))})]})}}const NormalInput=styled.input`
  border: none;
  border-bottom: 1px solid var(--bg_control);
  color: var(--color_accent);
  background: var(--bg_menu);
...
`,makeReaderPromise=e=>new Promise((t,o)=>{const n=new FileReader;n.onload=()=>{if(!n.result)return o();t([e.name,n.result.toString()])},n.onerror=o,n.onabort=o,n.readAsBinaryString(e)}),isVIADefinition=e=>dist.isVIADefinitionV2(e)||dist.isVIADefinitionV3(e);function importDefinitions(e,t,o,n){Promise.all(e.map(makeReaderPromise)).then(r=>{let s=[];n([]);const i=r.map(([a,c])=>{if(s.length>0)return null;try{const l=JSON.parse(c.toString());if(t==="v2"?dist.isKeyboardDefinitionV2(l)||dist.isVIADefinitionV2(l):dist.isKeyboardDefinitionV3(l)||dist.isVIADefinitionV3(l))return t==="v2"?dist.isVIADefinitionV2(l)?l:dist.keyboardDefinitionV2ToVIADefinitionV2(l):dist.isVIADefinitionV3(l)?l:dist.keyboardDefinitionV3ToVIADefinitionV3(l);s=(t==="v2"?dist.isKeyboardDefinitionV2.errors||dist.isVIADefinitionV2.errors||[]:dist.isKeyboardDefinitionV3.errors||dist.isVIADefinitionV3.errors||[]).map(u=>`${a} ${u.dataPath?u.dataPath+": ":"Object: "}${u.message}`)}catch(l){l.name?s.push(`${l.name}: ${l.message}`):s.push(`${l}`)}}).filter(isVIADefinition);s.length?n(s):(o(loadCustomDefinitions({definitions:i,version:t})),o(storeCustomDefinitions({definitions:i,version:t})),o(ensureSupportedIds({productIds:i.map(a=>a.vendorProductId),version:t})),o(selectDevice(null)),o(reloadConnectedDevices()))})}function onDrop(e,t,o,n){e.preventDefault();const{dataTransfer:r}=e;if(r!=null&&r.items){const s=Array.from(r.items).filter(i=>i.kind==="file"&&i.type==="application/json").map(i=>i.getAsFile()).filter(i=>i!==null);s.length&&importDefinitions(s,t,o,n)}}const DesignTab=()=>{const e=useDispatch(),t=Object.values(useAppSelector(getCustomDefinitions)),o=useAppSelector(getDesignDefinitionVersion),n=useAppSelector(getSelectedDefinitionIndex),r=useAppSelector(getShowMatrix),[s,i]=reactExports.useState([]),a=reactExports.useMemo(()=>t.filter(_=>_[o]),[t,o]),c=a.map((_,C)=>({label:_[o].name,value:C.toString()})),l=reactExports.useRef(null),d=a[n]&&a[n][o],u=reactExports.useRef();return jsxs(DesignPane,{onDragOver:_=>{_.dataTransfer.effectAllowed="copyMove",_.dataTransfer.dropEffect="none",_.preventDefault(),_.stopPropagation()},children:[jsx(MessageDialog,{isOpen:!hideDesignWarning,onClose:()=>{sessionStorage.setItem("hideDesignWarning","1"),hideDesignWarning="1",designWarningSeen=designWarningSeen+1,localStorage.setItem("designWarningSeen",`${designWarningSeen}`)},children:"This feature is intended for development purposes. If your keyboard is not recognized automatically by VIA, please contact your keyboard's manufacturer or vendor."}),jsx(SinglePaneFlexCell,{ref:l,children:!d&&jsx(UploadIcon,{onClick:()=>{u.current&&u.current.click()},onDrop:_=>onDrop(_,o,e,i),onDragOver:_=>{_.dataTransfer.effectAllowed="copyMove",_.dataTransfer.dropEffect="copy",_.preventDefault(),_.stopPropagation()},children:jsx(FontAwesomeIcon,{icon:faUpload})})}),jsxs(Grid,{style:{overflow:"hidden"},children:[jsx(MenuCell,{style:{pointerEvents:"all"},children:jsx(MenuContainer$5,{children:jsx(Row,{$selected:!0,children:jsxs(IconContainer,{children:[jsx(FontAwesomeIcon,{icon:faBook}),jsx(MenuTooltip,{children:"Add Definition"})]})})})}),jsx(SpanOverflowCell,{children:jsxs(Container$4,{children:[jsxs(ControlRow,{children:[jsx(Label$1,{children:"Load Draft Definition"}),jsx(Detail,{children:jsx(AccentUploadButton,{multiple:!0,inputRef:u,onLoad:_=>{importDefinitions(Array.from(_),o,e,i)},children:"Load"})})]}),jsxs(ControlRow,{children:[jsx(Label$1,{children:"Use V2 definitions (deprecated)"}),jsx(Detail,{children:jsx(AccentSlider,{isChecked:o==="v2",onChange:_=>e(updateDesignDefinitionVersion(_?"v2":"v3"))})})]}),d&&jsx(Fragment,{children:jsxs(ControlRow,{children:[jsx(Label$1,{children:"Shown Keyboard Definition"}),jsx(Detail,{children:jsx(AccentSelect,{onChange:_=>{e(updateSelectedOptionKeys([])),_&&e(updateSelectedDefinitionIndex(+_.value))},value:c[n],options:c})})]})}),d&&jsx(Layouts,{definition:d,onLayoutChange:_=>{e(updateSelectedOptionKeys(_))}}),d&&jsxs(ControlRow,{children:[jsx(Label$1,{children:"Show Matrix"}),jsx(Detail,{children:jsx(AccentSlider,{isChecked:r,onChange:_=>{e(updateShowMatrix(_))}})})]}),s.map(_=>jsx(IndentedControlRow,{children:jsx(DesignErrorMessage,{children:_})})),jsxs(ControlRow,{children:[jsx(Label$1,{children:"Draft Definitions"}),jsxs(Detail,{children:[Object.values(a).length," Definitions"]})]}),a.map(_=>jsxs(IndentedControlRow,{children:[jsx(SubLabel,{children:_[o].name}),jsxs(Detail,{children:[formatNumberAsHex(_[o].vendorProductId,8),jsx(IconButtonUnfilledContainer,{onClick:()=>{e(unloadCustomDefinition({id:_[o].vendorProductId,version:o}))},style:{marginLeft:10,borderRadius:4},children:jsx(FontAwesomeIcon,{icon:faXmark,size:"lg"})})]})]},`${o}-${_[o].vendorProductId}`))]})})]})]})},Container$3=styled.div`
  display: flex;
  align-items: center;
  flex-direction: column;
  padding: 0 12px;
...
`,ExternalLinks=()=>jsxs(ExternalLinkContainer,{children:[jsx("span",{children:"This app is a fork of"}),jsx("a",{href:"https://caniusevia.com/",target:"_blank",children:jsxs(CategoryIconContainer,{children:[jsx(VIALogo,{height:"25px",fill:"currentColor"}),jsx(CategoryMenuTooltip,{children:"Firmware + Docs"})]})}),jsx("a",{href:"https://discord.gg/NStTR5YaPB",target:"_blank",children:jsxs(CategoryIconContainer,{children:[jsx(FontAwesomeIcon,{size:"xl",icon:faDiscord}),jsx(CategoryMenuTooltip,{children:"Discord"})]})}),jsx("a",{href:"https://github.com/talex-tnt/via-col-vento",target:"_blank",children:jsxs(CategoryIconContainer,{children:[jsx(FontAwesomeIcon,{size:"xl",icon:faGithub}),jsx(CategoryMenuTooltip,{children:"Github"})]})})]}),Container=styled.div`
  ...
  align-items: center;
  justify-content: center;
`,{DEBUG_PROD,MODE,DEV}={BASE_URL:"/via-col-vento-dev",MODE:"production",DEV:!1,PROD:!0,SSR:!1},showDebugPane=MODE==="development"||DEBUG_PROD==="true"||DEV,GlobalContainer=styled(Container)`
...
`,UsbErrorWebHIDLink=styled.a`
  text-decoration: underline;
  color: var(--color_label-highlighted);
`,timeoutRepeater=(e,t,o=0)=>()=>setTimeout(()=>{e(),o>0&&timeoutRepeater(e,t,o-1)()},t),Home=e=>{const{hasHIDSupport:t}=e,o=useAppDispatch();useAppSelector(getSelectedKey),useAppSelector(getSelectedDefinition),useAppSelector(getConnectedDevices),useAppSelector(getSelectedLayerIndex),useAppSelector(getSelectedKeyDefinitions),useAppSelector(getDisableFastRemap),useAppSelector(getBasicKeyToByte);const n=useAppSelector(getSelectedKeyboardAPI),r=timeoutRepeater(()=>{o(reloadConnectedDevices())},500,1),s=reactExports.createRef();return reactExports.useEffect(()=>{if(t)return s.current&&s.current.focus(),startMonitoring(),usbDetect.on("change",r),o(loadSupportedIds()),()=>{usbDetect.off("change",r)}},[]),reactExports.useEffect(()=>{o(updateSelectedKey(null))},[n]),!t&&!OVERRIDE_HID_CHECK?jsx(ErrorHome,{ref:s,tabIndex:0,children:jsxs(UsbError,{children:[jsx(UsbErrorIcon,{children:"❌"}),jsx(UsbErrorHeading,{children:"USB Detection Error"}),jsxs("p",{children:["Looks like there was a problem getting USB detection working. Right now, we only support"," ",jsx(UsbErrorWebHIDLink,{href:"https://caniuse.com/?search=webhid",target:"_blank",children:"browsers that have WebHID enabled"}),", so make sure yours is compatible before trying again."]})]})}):jsx(Fragment,{children:e.children})},cubeySrc="/via-col-vento-dev/assets/cubey-495d68a6.glb",glbSrc="/via-col-vento-dev/assets/keyboard_components-1a09821a.glb",useSize=e=>{const[t,o]=reactExports.useState();return reactExports.useLayoutEffect(()=>{e.current&&o(e.current.getBoundingClientRect())},[e]),useResizeObserver(e,n=>o(n.contentRect)),t};var DisplayMode=(e=>(e[e.Test=1]="Test",e[e.Configure=2]="Configure",e[e.Design=3]="Design",e[e.ConfigureColors=4]="ConfigureColors",e))(DisplayMode||{}),KeycapState=(e=>(e[e.Pressed=1]="Pressed",e[e.Unpressed=2]="Unpressed",e))(KeycapState||{});const useColorPainter=(e,t)=>{const o=useAppSelector(getSelectedConnectedDevice),n=useAppSelector(getSelectedKeyboardAPI),r=useAppSelector(getSelectedCustomMenuData)||{__perKeyRGB:[]},[s,i]=reactExports.useState([]);reactExports.useEffect(()=>{const c=r.__perKeyRGB??[],d=(e.find(u=>"li"in u)?e.map(u=>u.li??-1):[]).map(u=>{const _=c[u??-1];if(_)return getHSVFrom256(_)});i(d)},[r.__perKeyRGB&&r.__perKeyRGB.length,e]);const a=reactExports.useCallback((c,l)=>{if(c.buttons===1&&n){const d=Math.round(t[0]*255/360),u=Math.round(t[1]*255),_=e[l].li;_!==void 0&&(n.setPerKeyRGBMatrix(_,d,u),n.commitCustomMenu(0),i(C=>(C[l]=t,[...C])))}},[i,t,e,o]);return{keyColors:s,onKeycapPointerDown:a,onKeycapPointerOver:a}},Heart=React.memo(e=>{const t=Math.atan(2/e.caseWidth),o=(80+-30)/2,n=2,r=1,i=-(-e.caseWidth-r*2-n*2)/Math.cos(t),a=.1*i/22,c=95,l=95*a,d=(i-l)/2,u=reactExports.useMemo(()=>{const C=new Shape;return C.moveTo(a*(25-o),a*(25-c)),C.bezierCurveTo(a*(25-o),a*(25-c),a*(20-o),a*(0-c),a*(0-o),a*(0-c)),C.bezierCurveTo(a*(-30-o),a*(0-c),a*(-30-o),a*(35-c),a*(-30-o),a*(35-c)),C.bezierCurveTo(a*(-30-o),a*(55-c),a*(-10-o),a*(77-c),a*(25-o),a*(95-c)),C.bezierCurveTo(a*(60-o),a*(77-c),a*(80-o),a*(55-c),a*(80-o),a*(35-c)),C.bezierCurveTo(a*(80-o),a*(35-c),a*(80-o),a*(0-c),a*(50-o),a*(0-c)),C.bezierCurveTo(a*(35-o),a*(0-c),a*(25-o),a*(25-c),a*(25-o),a*(25-c)),C},[e.caseWidth,e.caseHeight,e.color]),_={depth:4,bevelEnabled:!0,bevelSegments:10,bevelSize:1,bevelThickness:1};return jsxs("mesh",{position:[-i+d,n*2+r*2+e.caseHeight/2,0],scale:1,rotation:[Math.PI/2,t,Math.PI/2],children:[jsx("extrudeGeometry",{attach:"geometry",args:[u,_]}),jsx("meshPhongMaterial",{color:e.color,transparent:!0,opacity:1})]})},shallowEqual),makeShape2=e=>{const t=Math.tan(Math.PI*7.5/180),o=10,n=o+t*e,r=e/2,s=new Shape;let i=2,a=Math.PI/2;return s.moveTo(-n,r),s.absarc(-n-i,r-i,i,a*1+a,a*1,!0),s.absarc(-i,r,i,a*1,a*1-a,!0),s.absarc(-i,-r,i,a*3+a,a*3,!0),s.absarc(-o-i,-r-i,i,a*2+a,a*2,!0),s},Case$1=React.memo(e=>{const t=useAppSelector(getSelectedTheme),o=reactExports.useMemo(()=>t[dist.KeyColorType.Accent].c,[t]),n="#212020",r=reactExports.useMemo(()=>t[dist.KeyColorType.Accent].t,[t]),s=e.width*KeycapMetric.keyXPos-KeycapMetric.keyXSpacing,i=KeycapMetric.keyYPos*e.height-KeycapMetric.keyYSpacing,a=4,c=s+a*1,l=s+a*2.5,[d,u]=reactExports.useMemo(()=>[i+a,i+a*2].map(makeShape2),[i]),_=1,C=10,K=10+Math.tan(Math.PI*7.5/180)*(i+a*2);return jsxs("group",{scale:1,"position-z":-_*2,"rotation-y":-Math.PI/2,children:[jsx(Heart,{caseWidth:K,caseHeight:i,color:r}),jsxs("mesh",{position:[-_,0,-l/2],castShadow:!0,children:[jsx("extrudeGeometry",{attach:"geometry",args:[u,{depth:l,bevelEnabled:!0,bevelSize:_,bevelThickness:_,bevelSegments:C}]}),jsx("meshPhongMaterial",{color:o,shininess:100,reflectivity:1,specular:getDarkenedColor(o,.2)})]}),jsxs("mesh",{position:[0,0,-c/2],castShadow:!0,children:[jsx("extrudeGeometry",{attach:"geometry",args:[d,{depth:c,bevelEnabled:!0,bevelSize:_/2,bevelThickness:_,bevelSegments:C}]}),jsx("meshPhongMaterial",{color:n,shininess:100,reflectivity:1,specular:getDarkenedColor(o,.2)})]})]})});function useSkipFontCheck(){const[e,t]=reactExports.useState(!1),o=reactExports.useCallback(()=>{t(!1)},[]),n=reactExports.useCallback(()=>{t(!0)},[]);return reactExports.useEffect(()=>{document.fonts.load("Fira Sans").then(o,n)},[]),e}function getKeycapSharedProps(e,t,o,n,r,s,i){const{position:a,rotation:c,scale:l,color:d,idx:u,onClick:_,onPointerDown:C,onPointerOver:h}=n.coords[t],p=e.ei!==void 0;return{mode:o.mode,position:a,rotation:c,scale:getScale(e,l),textureWidth:e.w,textureHeight:e.h,textureOffsetX:e.w2?Math.abs(e.w2-e.w):0,color:d,shouldRotate:p,onPointerDown:C,onPointerOver:h,keyState:o.pressedKeys?o.pressedKeys[t]:-1,disabled:!o.selectable,selected:t===r,idx:u,label:s[t],onClick:_,key:n.indices[t],skipFontCheck:i}}const getKeysKeysIndices=e=>(t,o)=>{const n=t.ei!==void 0;return`${e}-${o}-${t.w}-${t.h}-${n}`};function getLabels(e,t,o,n){return e.matrixKeycodes.length?e.keys.map((r,s)=>getLabel(e.matrixKeycodes[s],r.w,t,e.definition,o,n)):[]}function getKeysKeys(e,t,o,n){const{keys:r}=e,{rowMap:s}=getKeyboardRowPartitions(r),i=r.map(dist.getBoundingBox),[a,c]=[Math.min(...i.map(d=>d.xStart)),Math.min(...i.map(d=>d.yStart))],l=r.map(d=>{const u={...d};return a<0&&(u.x=u.x-a),c<0&&(u.y=u.y-c),u}).map(calculatePointPosition);return{indices:r.map(getKeysKeysIndices(e.definition.vendorProductId)),coords:r.map((d,u)=>{const[_,C]=l[u],h=d.r*(2*Math.PI)/360,p=KeycapMetric.keyXSpacing/KeycapMetric.keyWidth,K=KeycapMetric.keyYSpacing/KeycapMetric.keyHeight,y=(1+p)*(d.w2||d.w)-p,g=d.h*(1+K)-K,m=getMeshName(d,s[getKeyId(d)],!1),S=e.keyColors?u:d.color,M=t[S];return{position:n(_+a,C+c),rotation:[0,0,-h],scale:[y,g,1],color:M,meshKey:m,idx:u,onClick:(L,x)=>{L.stopPropagation(),o(updateSelectedKey(x))},onPointerDown:e.onKeycapPointerDown,onPointerOver:e.onKeycapPointerOver}})}}const useCanvasConfig=()=>{const[e]=useLocation(),t=useAppSelector(getLoadProgress),{progress:o}=useProgress(),n=Object.values(useAppSelector(getCustomDefinitions)),r=useAppSelector(getSelectedDefinition),s=useAppSelector(getDesignDefinitionVersion),i=reactExports.useMemo(()=>n.filter(u=>u[s]),[n,s]),a=e==="/design"&&!i.length,c=e==="/"&&(!r||(t+o/100)/2!==1),l="hid"in navigator||OVERRIDE_HID_CHECK;return{hideCanvasScene:!l||["/settings","/errors","/debug"].includes(e)||a||c,showAuthorizeButton:l,hideConfigureScene:c}};function fitTextToWidth(e,t,o,n=32,r=8,s="Arial",i=!0){let a=n,c=1/0;for(let l=0;l<10;l++){e.font=`${i?"bold ":""}${a}px ${s}`;const u=e.measureText(t).width;if(u<=o||u===c)break;const _=o/u;a=Math.max(Math.floor(a*_),r),c=u}return a}const getMacroData$1=({macroExpression:e,label:t})=>t&&t.length>15?t:e&&e.length?e:null,paintEncoder=(e,[t,o],n,r)=>{const[a,c]=[512*t,512*o];e.width=a,e.height=c;const l=e.getContext("2d"),d=2.6;if(l){l.fillStyle=n,l.clearRect(0,0,e.width,e.height),l.fillRect(0,0,e.width,e.height),l.fill(),l.fillStyle=r;const u=.4*a/d;l.ellipse(.5*a/d,2.1*c/d,u,u,Math.PI/4,0,2*Math.PI),l.fill()}},paintKeycapLabel$1=(e,t,o,n)=>{const r=e.getContext("2d");if(r==null)return;const s="Fira Sans, Arial Rounded MT, Arial Rounded MT Bold, Arial",i={x:.015,y:.02},a={x:.01,y:-.01},c={x:.01,y:.02};if(r.beginPath(),r.moveTo(t.bl.x*e.width,(1-t.bl.y)*e.height),r.lineTo(t.bl.x*e.width,(1-t.tr.y)*e.height),r.lineTo(t.tr.x*e.width,(1-t.tr.y)*e.height),r.lineTo(t.tr.x*e.width,(1-t.bl.y)*e.height),r.lineTo(t.bl.x*e.width,(1-t.bl.y)*e.height),r.clip(),r.fillStyle=o,n!==void 0){if(n.topLabel&&n.bottomLabel){let l=52,d=.75*l/e.height,u=n.offset[0]*d,_=n.offset[1]*d;r.font=`bold ${l}px ${s}`,r.fillText(n.topLabel,(t.bl.x+i.x)*e.width,(1-(t.tr.y-d-i.y-u))*e.height),r.fillText(n.bottomLabel,(t.bl.x+i.x)*e.width,(1-(t.bl.y+i.y+_))*e.height)}else if(n.centerLabel){let l=37.5*n.size,d=.75*l/e.height,u=(t.tr.y+t.bl.y)/2;const _=!0,C=(t.tr.x-(t.bl.x+a.x))*e.width,h=30;return fitTextToWidth(r,n.label,C,l,h,s,_),r.fillText(n.label,(t.bl.x+a.x)*e.width,(1-(u-.5*d-a.y))*e.height),r.measureText(n.centerLabel).width>C}else if(typeof n.label=="string"){let l=75,d=.75*l/e.height;r.font=`bold ${l}px ${s}`,r.fillText(n.label,(t.bl.x+c.x)*e.width,(1-(t.tr.y-d-c.y))*e.height)}}},calculateTextureRects=(e,t,o,n,r)=>{const s=.3846153846153846,c=.445/19.05*s;let l=Math.min(2.75,o),d=Math.min(2.75,n);(e>1||t>1)&&(l=1,d=1);let u={bl:{x:c,y:c},tr:{x:l*s-c,y:d*s-c}},_={bl:{x:u.bl.x+.07,y:u.bl.y+.08},tr:{x:u.tr.x-.07,y:u.tr.y-.0146}};return r>0&&(_.bl.x+=r*s,_.tr.x+=r*s,u.bl.x+=r*s,u.tr.x+=r*s),{keycapRect:u,faceRect:_}},paintKeycap$1=(e,[t,o],n,r,s,i,a,c)=>{const l=calculateTextureRects(t,o,n,r,c),d=512;e.width=d*t,e.height=d*o;const u=e.getContext("2d");if(u!=null)return u.fillStyle=s,u.fillRect(0,0,e.width,e.height),paintKeycapLabel$1(e,l.faceRect,i,a)},Keycap$1=React.memo(e=>{const{label:t,scale:o,color:n,onClick:r,selected:s,disabled:i,mode:a,rotation:c,keyState:l,shouldRotate:d,keycapGeometry:u,textureOffsetX:_,textureWidth:C,textureHeight:h,onPointerOver:p,onPointerDown:K,idx:y}=e,g=reactExports.useRef(),m=t&&getMacroData$1(t),[S,M]=reactExports.useState(!1),[L,x]=reactExports.useState(!1),b=reactExports.useRef(),D=reactExports.useRef(document.createElement("canvas")),O=React.useCallback(()=>{if(D.current&&n){if(d)paintEncoder(D.current,[o[0],o[1]],n.c,n.t);else{const H=paintKeycap$1(D.current,[o[0],o[1]],C,h,n.c,n.t,t,_);M(!!H)}b.current.needsUpdate=!0}},[D.current,C,t&&t.key,o[0],o[1],n&&n.t,n&&n.c,d]);reactExports.useEffect(O,[t&&t.key,n&&n.c,n&&n.t]);const j=useSpring({config:{duration:800},from:{x:0,y:"#f4a0a0"},loop:s?{reverse:!0}:!1,to:{x:100,y:"#b49999"}});let k=u.boundingBox.max.z;const[A,R]=[k,k+8],I=DisplayMode.Test===a?TestKeyState.KeyDown===l?KeycapState.Pressed:KeycapState.Unpressed:L||s?KeycapState.Unpressed:KeycapState.Pressed,[P,w]=I===KeycapState.Pressed?[A,c[2]]:[R,c[2]+Math.PI*Number(d)],U=l===TestKeyState.KeyUp,$=DisplayMode.Test===a?I===KeycapState.Unpressed?U?"palevioletred":"lightgrey":"pink":(I===KeycapState.Unpressed,"lightgrey"),{z:Y,b:E,rotateZ:B,tooltipScale:v}=useSpring({config:{duration:100},z:P,b:$,rotateZ:w,tooltipScale:L?1:0}),[T,N,F,W]=reactExports.useMemo(()=>{const H=()=>{};return i?[H,H,H,H]:e.mode===DisplayMode.ConfigureColors?[H,G=>{p&&p(G,y)},H,G=>{K&&K(G,y)}]:[G=>r(G,y),G=>{p&&p(G,y),x(!0)},()=>x(!1),G=>{K&&K(G,y)}]},[i,r,K,p,x,y,a]),Q=animated.meshPhongMaterial;return jsxs(Fragment,{children:[jsx(animated.mesh,{...e,ref:g,"position-z":Y,"rotation-z":B,onClick:T,onPointerDown:W,onPointerOver:N,onPointerOut:F,geometry:u,children:jsx(Q,{attach:"material",color:s?j.y:E,children:jsx("canvasTexture",{ref:b,attach:"map",image:D.current})})}),(m||(t==null?void 0:t.tooltipLabel))&&jsx(React.Suspense,{fallback:null,children:jsx(animated.group,{position:e.position,"position-z":20,scale:v,children:jsx(Html,{transform:!0,style:{pointerEvents:"none"},children:jsx(KeycapTooltip,{children:m||t&&t.tooltipLabel})})})})]})},shallowEqual),getSRGBArray=e=>e.map(([t,o])=>{const n=getRGB({hue:Math.round(255*t/360),sat:Math.round(255*o)}),r=`#${new Color(n).convertSRGBToLinear().getHexString()}`;return{c:r,t:r}}),getPosition$1=(e,t)=>[KeycapMetric.keyXPos*e/CSSVarObject.keyXPos,-t*KeycapMetric.keyYPos/CSSVarObject.keyYPos,0],KeyGroup$1=e=>{const t=useAppDispatch(),o=useGLTF(glbSrc,!0).scene,n=useAppSelector(getSelectedKey),r=useAppSelector(getSelectedSRGBTheme),s=useAppSelector(getExpressions),i=useSkipFontCheck(),a=e.keyColors?getSRGBArray(e.keyColors):r,{basicKeyToByte:c,byteToKey:l}=useAppSelector(getBasicKeyToByte),d=useAppSelector(m=>m.macros),{keys:u,selectedKey:_}=e,C=_===void 0?n:_,h=reactExports.useMemo(()=>getKeysKeys(e,a,t,getPosition$1),[u,a,e.onKeycapPointerDown,e.onKeycapPointerOver]),p=reactExports.useMemo(()=>getLabels(e,s,c,l),[u,e.matrixKeycodes,d,e.definition]),{width:K,height:y}=calculateKeyboardFrameDimensions(u),g=reactExports.useMemo(()=>e.keys.map((m,S)=>{const{meshKey:M}=h.coords[S],{key:L,...x}=getKeycapSharedProps(m,S,e,h,C,p,i);return m.d?null:jsx(Keycap$1,{keycapGeometry:(o.getObjectByName(M)||o.getObjectByName("K-R1-100")).geometry,...x},L)}),[u,C,p,e.pressedKeys,e.selectable,a,e.definition.vendorProductId,i]);return jsx("group",{scale:1,position:[(-K*KeycapMetric.keyXPos+KeycapMetric.keyXSpacing)/2,(KeycapMetric.keyYPos*y-KeycapMetric.keyYSpacing)/2,0],children:g})},generateRowColArray=(e,t,o)=>{const n=e.filter(i=>i.ei===void 0&&!i.d),r=n.reduce((i,a)=>(i[a.row][a.col]=calculatePointPosition(a),i),Array(t).fill(0).map(()=>Array(o).fill(0))).map(i=>i.sort((a,c)=>a[0]-c[0])),s=n.reduce((i,a)=>(i[a.col][a.row]=calculatePointPosition(a),i),Array(o).fill(0).map(()=>Array(t).fill(0))).map(i=>i.sort((a,c)=>a[1]-c[1]));return{rowKeys:r,colKeys:s}},MatrixLines$1=({keys:e,rows:t,cols:o,width:n,height:r})=>{const[s,i]=["lightpink","lightgrey"],{rowKeys:a,colKeys:c}=generateRowColArray(e,t,o);return jsx("group",{scale:.35,rotation:[Math.PI,0,0],position:[-n*KeycapMetric.keyXPos/2,(r+.4)*KeycapMetric.keyYPos/2,11],children:jsxs(Segments,{lineWidth:1,children:[a.flatMap(l=>{const d=l.filter(u=>u);return d.length>=2?d.reduce((u,_,C)=>u.prev===null?{res:[],prev:_}:{res:[...u.res,jsx(Segment,{start:[u.prev[0],u.prev[1],0],end:[_[0],_[1],0],color:s},`row-${C}`)],prev:_},{res:[],prev:null}).res:[]}),c.flatMap(l=>{const d=l.filter(u=>u);return d.length>=2?d.reduce((u,_,C)=>u.prev===null?{res:[],prev:_}:{res:[...u.res,jsx(Segment,{start:[u.prev[0],u.prev[1],0],end:[_[0],_[1],0],color:i},`col-${C}`)],prev:_},{res:[],prev:null}).res:[]})]})},`${t}-${o}-${n}-${r}`)},KeyboardCanvas$1=e=>{const{containerDimensions:t,shouldHide:o,...n}=e,{width:r,height:s}=reactExports.useMemo(()=>calculateKeyboardFrameDimensions(n.keys),[n.keys]),[i,a]=reactExports.useState(!1),{verticalPostion:c,tilt:l}=useSpring({config:{tension:35,friction:5,mass:.3},verticalPostion:i?1:-3,tilt:i?-.15:0});reactExports.useEffect(()=>{const m=document.querySelector("canvas");m&&(m.addEventListener("mouseenter",()=>{a(!0)}),m.addEventListener("mouseleave",()=>{a(!1)}))},[]);const d=t.height,u=t.width,_=60,C=(CSSVarObject.keyWidth+CSSVarObject.keyXSpacing)*r-CSSVarObject.keyXSpacing+_*2,h=(CSSVarObject.keyHeight+CSSVarObject.keyYSpacing)*s-CSSVarObject.keyYSpacing+_*2,p=u/C,K=d/h,y=Math.min(p,K),g=Math.max(1,y)||1;return jsx("group",{position:[0,-0,-19],scale:.01*g,visible:!o,children:jsx(KeyboardCanvasContent$1,{...n,width:r,height:s,verticalPostion:c,tilt:l})})},KeyboardCanvasContent$1=React.memo(e=>{const{matrixKeycodes:t,keys:o,definition:n,pressedKeys:r,mode:s,showMatrix:i,selectable:a,width:c,height:l,verticalPostion:d,tilt:u}=e;return jsx(animated.group,{"position-y":d,"rotation-x":u,children:jsxs(PresentationControls,{enabled:e.mode!==DisplayMode.ConfigureColors,global:!0,snap:!0,speed:1,zoom:1,polar:[-Math.PI/10,Math.PI/10],azimuth:[-Math.PI/16,Math.PI/16],config:{mass:1,tension:170,friction:26},children:[jsx(Case$1,{width:c,height:l}),jsx(KeyGroup$1,{...e,keys:o,mode:s,matrixKeycodes:t,selectable:a,definition:n,pressedKeys:r}),i&&jsx(MatrixLines$1,{keys:o,rows:n.matrix.rows,cols:n.matrix.cols,width:c,height:l})]})})},shallowEqual),CaseGroup=styled.div``,OuterCase=styled.div`
...
`,EncoderKey=e=>jsx(EncoderKeyContainer,{onClick:e.onClick,style:e.style,children:jsx(EncoderKeyContent2,{$size:e.size&&+e.size,$innerPadding:5*e.size/52})}),getMacroData=({macroExpression:e,label:t})=>t&&t.length>15?t:e&&e.length?e:null,paintKeycapLabel=(e,t,o)=>{const n=e.getContext("2d");if(n==null)return;const r=devicePixelRatio,[s,i]=[e.width,e.height];e.width=s*r,e.height=i*r,e.style.width=`${s}px`,e.style.height=`${i}px`,n.scale(r,r);const a="Fira Sans, Arial Rounded MT, Arial Rounded MT Bold, Arial",c={x:4,y:4},l={x:4,y:4},d={x:3,y:0},u={x:4,y:4};if(n.beginPath(),n.moveTo(0,0),n.lineTo(e.width,0),n.lineTo(e.width,e.height),n.lineTo(0,e.height),n.lineTo(0,0),n.clip(),n.fillStyle=t,o!==void 0){if(o.topLabel&&o.bottomLabel){let _=16,C=.75*_,h=o.offset[0]*C,p=o.offset[1]*C;n.font=`bold ${_}px ${a}`,n.fillText(o.topLabel,c.x,c.y+h+C),n.fillText(o.bottomLabel,l.x,i-l.y-p)}else if(o.centerLabel){let _=13*o.size,C=.75*_,h=i/2;const p=!0,K=s-d.x,y=10;return fitTextToWidth(n,o.label,K,_,y,a,p),n.fillText(o.label,d.x,h+.5*C),n.measureText(o.centerLabel).width>K}else if(typeof o.label=="string"){let _=22,C=.75*_;n.font=`bold ${_}px ${a}`,n.fillText(o.label,u.x,u.y+C)}}},paintKeycap=(e,t,o,n,r)=>{const[s,i]=[CSSVarObject.keyWidth,CSSVarObject.keyHeight];if(e.width=s*t-CSSVarObject.faceXPadding.reduce((c,l)=>c+l,0),e.height=i*o-CSSVarObject.faceYPadding.reduce((c,l)=>c+l,0),e.getContext("2d")!=null)return paintKeycapLabel(e,n,r)},Keycap=React.memo(e=>{const{label:t,scale:o,color:n,selected:r,disabled:s,mode:i,rotation:a,keyState:c,shouldRotate:l,textureWidth:d,textureHeight:u,skipFontCheck:_,idx:C}=e,h=t&&getMacroData(t),[p,K]=reactExports.useState(!1),[y,g]=reactExports.useState(!1),m=reactExports.useRef(null),S=React.useCallback(()=>{if(m.current&&n&&t&&(document.fonts.check('bold 16px "Fira Sans"',t.label)||_)){const P=paintKeycap(m.current,d,u,n.t,t);K(!!P)}},[m.current,d,t&&t.key,o[0],o[1],n&&n.t,n&&n.c,l]);reactExports.useEffect(S,[t&&t.key,_,n&&n.c,n&&n.t]),reactExports.useEffect(()=>(document.fonts.addEventListener("loadingdone",S),()=>{document.fonts.removeEventListener("loadingdone",S)}),[]);const[M,L]=[-8,0],x=DisplayMode.Test===i?TestKeyState.KeyDown===c?KeycapState.Pressed:KeycapState.Unpressed:y||r?KeycapState.Pressed:KeycapState.Unpressed,[b]=x===KeycapState.Pressed?[M,a[2]]:[L,a[2]+Math.PI*Number(l)],D=c===TestKeyState.KeyUp,O=DisplayMode.Test===i?x===KeycapState.Unpressed?D?"mediumvioletred":"lightgrey":"mediumvioletred":(x===KeycapState.Unpressed,"lightgrey"),j=x===KeycapState.Unpressed?D?.4:0:.6,[k,A,R,I]=reactExports.useMemo(()=>{const P=()=>{};return s?[P,P,P,P]:e.mode===DisplayMode.ConfigureColors?[P,w=>{e.onPointerOver&&e.onPointerOver(w,C)},P,w=>{e.onPointerDown&&e.onPointerDown(w,C)}]:[w=>e.onClick(w,C),w=>{e.onPointerOver&&e.onPointerOver(w,C),g(!0)},()=>g(!1),w=>{e.onPointerDown&&e.onPointerDown(w,C)}]},[s,e.onClick,e.onPointerDown,e.onPointerOver,g,C,i]);return l?jsx(EncoderKey,{onClick:k,size:d*CSSVarObject.keyWidth,style:{transform:`translate(${e.position[0]-(CSSVarObject.keyWidth*d-CSSVarObject.keyWidth)/2}px,${d*(CSSVarObject.keyHeight-CSSVarObject.keyWidth)/2+e.position[1]-(CSSVarObject.keyHeight*u-CSSVarObject.keyHeight)/2}px) rotate(${-e.rotation[2]}rad)`,borderRadius:3,color:e.color.c}}):e.clipPath?jsx(ComboKeycap,{...e,onClick:k,onPointerDown:I,onPointerOver:A,onPointerOut:R,keycapZ:b,keycapOpacity:j,keycapColor:O,canvasRef:m,macroData:h,overflowsTexture:p,style:{transform:`translate(${CSSVarObject.keyWidth/2+e.position[0]-(CSSVarObject.keyXPos*d-CSSVarObject.keyXSpacing)/2}px,${CSSVarObject.keyHeight/2+e.position[1]-(CSSVarObject.keyYPos*u-CSSVarObject.keyYSpacing)/2}px) rotate(${-e.rotation[2]}rad)`,width:d*CSSVarObject.keyXPos-CSSVarObject.keyXSpacing,height:u*CSSVarObject.keyYPos-CSSVarObject.keyYSpacing}}):jsx(Fragment,{children:jsxs(KeycapContainer,{onClick:k,onPointerDown:I,onPointerOver:A,onPointerOut:R,style:{transform:`translate(${CSSVarObject.keyWidth/2+e.position[0]-(CSSVarObject.keyXPos*d-CSSVarObject.keyXSpacing)/2}px,${CSSVarObject.keyHeight/2+e.position[1]-(CSSVarObject.keyYPos*u-CSSVarObject.keyYSpacing)/2}px) rotate(${-e.rotation[2]}rad)`,width:d*CSSVarObject.keyXPos-CSSVarObject.keyXSpacing,height:u*CSSVarObject.keyYPos-CSSVarObject.keyYSpacing,cursor:s?"initial":"pointer"},children:[jsxs(GlowContainer,{$selected:r,style:{animation:s?"initial":r?".75s infinite alternate select-glow":"",background:getDarkenedColor(e.color.c,.8),transform:`perspective(100px) translateZ(${b}px)`,borderRadius:3,width:d*CSSVarObject.keyXPos-CSSVarObject.keyXSpacing,height:u*CSSVarObject.keyYPos-CSSVarObject.keyYSpacing},children:[DisplayMode.Test===i?jsx(TestOverlay,{style:{background:O,opacity:j}}):null,jsx(CanvasContainer,{style:{borderRadius:4,background:e.color.c,height:"100%"},children:jsx("canvas",{ref:m,style:{}})})]}),(h||(t==null?void 0:t.tooltipLabel))&&jsx(TooltipContainer,{$rotate:a[2],children:jsx(Keycap2DTooltip,{children:h||t&&t.tooltipLabel})})]})})},shallowEqual),GlowContainer=styled.div`
  box-sizing: border-box;
  padding: 2px 6px 10px 6px;
  transition: transform 0.2s ease-out;
  box-shadow: inset -1px -1px 0 rgb(0 0 0 / 20%),
...
`,getPosition=(e,t)=>[e-CSSVarObject.keyWidth/2,t-CSSVarObject.keyHeight/2,0],getRGBArray=e=>e.map(([t,o])=>{const n=getRGB({hue:Math.round(255*t/360),sat:Math.round(255*o)}),r=`#${new Color(n).getHexString()}`;return{c:r,t:r}}),KeyGroup=e=>{const t=useAppDispatch(),o=useAppSelector(getSelectedKey),n=useAppSelector(getSelectedTheme),r=useAppSelector(getExpressions),s=useSkipFontCheck(),i=e.keyColors?getRGBArray(e.keyColors):n,{basicKeyToByte:a,byteToKey:c}=useAppSelector(getBasicKeyToByte),l=useAppSelector(g=>g.macros),{keys:d,selectedKey:u}=e,_=u===void 0?o:u,C=reactExports.useMemo(()=>getKeysKeys(e,i,t,getPosition),[d,i,e.onKeycapPointerDown,e.onKeycapPointerOver]),h=reactExports.useMemo(()=>getLabels(e,r,a,c),[d,e.matrixKeycodes,l,e.definition]),{width:p,height:K}=calculateKeyboardFrameDimensions(d),y=reactExports.useMemo(()=>e.keys.map((g,m)=>g.d?null:jsx(Keycap,{...getComboKeyProps(g),...getKeycapSharedProps(g,m,e,C,_,h,s)})),[d,_,h,e.pressedKeys,e.selectable,i,e.definition.vendorProductId,s]);return jsx(KeyGroupContainer,{height:K,width:p,style:{pointerEvents:e.selectable?"all":"none"},children:y})},Matrix=({rowKeys:e,colKeys:t})=>jsxs(SVG,{style:{position:"absolute",top:CSSVarObject.insideBorder,left:CSSVarObject.insideBorder},children:[e.map((o,n)=>jsx(RowLine,{points:o.map(r=>(r||[]).join(",")).join(" ")},n)),t.map((o,n)=>jsx(ColLine,{points:o.map(r=>(r||[]).join(",")).join(" ")},n))]}),SVG=styled.svg`
  transform: rotateZ(0);
  width: 100%;
  height: 100%;
...
`,KeyboardRouteGroup=styled.div`
  ...
  align-items: center;
  justify-content: center;
`,CanvasRouter=({height:e="50%"})=>{const[t]=useLocation(),o=reactExports.useRef(document.body),n=reactExports.useRef(null),r=useAppSelector(getLoadProgress),s=useAppDispatch(),i=useSize(n),a=useSize(o),c=useAppSelector(getSelectedDefinition),l=useAppSelector(getSelectedTheme),d=reactExports.useMemo(()=>l[dist.KeyColorType.Accent].c,[l]),u=t==="/"&&(!c||r!==1),_=reactExports.useCallback(()=>{s(updateSelectedKey(null))},[s]),C=useAppSelector(getConfigureKeyboardIsSelectable),{hideCanvasScene:h,showAuthorizeButton:p}=useCanvasConfig(),K=u;return jsx(Fragment,{children:jsx("div",{style:{height:e,width:"100%",top:0,transform:h?K?a?`translateY(${-300+a.height/2}px)`:"":"translateY(-500px)":"",position:h&&!K?"absolute":"relative",overflow:"visible",zIndex:2,visibility:h&&!K?"hidden":"visible"},onClick:y=>{y.target.nodeName!=="CANVAS"&&s(clearSelectedKey())},ref:n,children:h?null:jsxs(Fragment,{children:[jsx(KeyboardBG,{onClick:_,$color:d,$visible:!K}),jsx(KeyboardGroup,{containerDimensions:i,configureKeyboardIsSelectable:C,loadProgress:r})]})})})},getRouteX=e=>{switch(e){case"/debug":return-300;case"/design":return-200;case"/test":return-100;case"/":return 0;default:return-300}},KeyboardGroupContainer=styled.div`
  z-index: 2;
  display: block;
  white-space: nowrap;
  height: 100%;
...
`;function InnerRoutes(){const e="hid"in navigator||OVERRIDE_HID_CHECK,{hideCanvasScene:t,hideConfigureScene:o}=useCanvasConfig(),n=reactExports.useRef();reactExports.useEffect(()=>{const l=getPanelElement("top-panel"),d=getPanelElement("bottom-panel"),u=getResizeHandleElement("resize-handle");n.current={topPanelElement:l,bottomPanelElement:d,resizeHandleElement:u}},[]);const r=o?"50%":"100%",s=useAppSelector(getRenderMode),i=reactExports.useMemo(()=>PANES.map(l=>jsx(Route,{component:l.component,path:l.path},l.key)),[]),a=s==="2D",c=a?CanvasRouter:CanvasRouter$1;return reactExports.useState({clearTestKeys:()=>{}}),reactExports.useEffect(()=>{if(n.current){const{topPanelElement:l,bottomPanelElement:d,resizeHandleElement:u}=n.current;l&&d&&u&&(o?(l.style.display=a?"none":"block",d.style.display=a?"block":"none",u.style.display="none"):(l.style.display=t?"none":"block",d.style.display="block",u.style.display=t?"none":"block"))}},[t,o]),jsxs(Fragment,{children:[e&&jsx(UnconnectedGlobalMenu,{}),jsxs(PanelGroup,{direction:"vertical",children:[jsx(Panel,{id:"top-panel",children:jsx(c,{height:r})}),jsx(PanelResizeHandle,{id:"resize-handle"}),jsx(Panel,{id:"bottom-panel",children:jsx(Home,{hasHIDSupport:e,children:i})})]})]})}const Routes=()=>{const e=reactExports.useState({clearTestKeys:()=>{}}),t="/via-col-vento-dev";return jsx(Fragment,{children:jsxs(TestContext.Provider,{value:e,children:[jsx(GlobalStyle,{}),jsx(Router,{base:t,children:jsx(InnerRoutes,{})})]})})},Root=()=>jsx(Provider_default,{store,children:jsx(Routes,{})}),elem=document.getElementById("root");elem&&(createRoot(elem).render(jsx(Root,{})),document.documentElement.dataset.themeMode=getThemeModeFromStore(),updateCSSVariables(getThemeNameFromStore()));
