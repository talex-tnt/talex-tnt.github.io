...
`,componentJoin=(e,t)=>e.reduce((o,n,r)=>(r&&o.push({...t,key:r.toString()}),o.push(n),o),[]),KeycodeMap=getKeycodes().flatMap(e=>e.keycodes).reduce((e,t)=>({...e,[t.code]:t}),{}),optimizeKeycodeSequence=e=>pipeline(e,convertCharacterTaps,trimLastWait,mergeConsecutiveWaits,foldKeydownKeyupKeys,convertToCharacterStreams),cleanKeycodeSequence=e=>pipeline(e,mergeConsecutiveWaits),MacroRecorder=({selectedMacro:e,setUnsavedMacro:t,saveMacro:o,undoMacro:n,isDelaySupported:r})=>{const[s,a]=reactExports.useState(!0),[i,c]=reactExports.useState(!1),[l,d]=reactExports.useState(!1),[u,C]=reactExports.useState(!!document.fullscreenElement),{smartOptimizeEnabled:_,recordDelaysEnabled:h}=useAppSelector(getMacroEditorSettings),p=useDispatch(),[K,y]=useKeycodeRecorder(i,h),g=reactExports.useRef(null),m=reactExports.useCallback(async A=>{c(A),A?(await navigator.keyboard.lock(),y([]),a(!1),d(!0)):(navigator.keyboard.unlock(),_&&y(optimizeKeycodeSequence(K)),d(!1))},[K,c]),S=reactExports.useCallback(()=>{o(""),a(!0),d(!1)},[y,o]),M=reactExports.useCallback(()=>{n(),y([]),a(!0),d(!1)},[n]);reactExports.useEffect(()=>{a(!0),d(!1),y([])},[e]);const b=()=>[...s?e??[]:K],f=reactExports.useMemo(()=>{let A,R=b();return s||!l||!_?A=R:A=optimizeKeycodeSequence(R),A},[K,s,_,l,e]);reactExports.useEffect(()=>{f&&t(sequenceToExpression(f))},[f]);const T=reactExports.useCallback(()=>{s&&a(!1)},[s]),D=reactExports.useCallback(A=>{const R=b();R.splice(A,1),y(cleanKeycodeSequence(R)),T()},[f,e,K,s]),v=reactExports.useCallback((A,R)=>{const I=b();I.splice(A,1,[RawKeycodeSequenceAction.Delay,R]),y(cleanKeycodeSequence(I)),T()},[f,e,K,s]),j=reactExports.useMemo(()=>componentJoin(f.map(([A,R],I)=>{const P=getSequenceItemComponent(A);return jsx(Deletable,{index:I,deleteItem:D,disabled:i,children:RawKeycodeSequenceAction.Delay!==A?jsx(P,{children:A===RawKeycodeSequenceAction.CharacterStream?componentJoin(String(R).split(" ").map((w,H)=>jsx("span",{children:w},H)),jsx("span",{style:{fontFamily:"fantasy, cursive, monospace"},children:"␣"})):Array.isArray(R)?R.map(w=>getSequenceLabel(KeycodeMap[w])??w).join(" + "):getSequenceLabel(KeycodeMap[R])}):jsx(WaitInput,{index:I,value:Number(R),updateValue:v})},`${I}-${A}`)}),jsx(SequenceLabelSeparator,{})),[f]);reactExports.useEffect(()=>{const A=()=>{C(!!document.fullscreenElement)};return document.documentElement.addEventListener("fullscreenchange",A),()=>{m(!1),document.documentElement.removeEventListener("fullscreenchange",A)}},[C]);const k=reactExports.useCallback(()=>{document.fullscreenElement?document.exitFullscreen&&(m(!1),document.exitFullscreen()):document.documentElement.requestFullscreen()},[m]);return jsxs(Fragment,{children:[jsx(MacroSequenceContainer,{ref:g,$isModified:!s,children:j.length?j:jsx(NoMacroRecorded,{children:"No macro recorded yet..."})}),jsx("div",{style:{border:"none",maxWidth:960,width:"100%",display:"flex",justifyContent:"center",transform:"translate(-0px, -21px)"},children:jsx(MacroEditControls,{isFullscreen:u,isEmpty:!e||!e.length,optimizeRecording:_,recordDelays:h,isRecording:i,addText:()=>{},deleteMacro:S,toggleOptimizeRecording:()=>{p(setMacroEditorSettings({smartOptimizeEnabled:!_}))},toggleRecordDelays:()=>{p(setMacroEditorSettings({recordDelaysEnabled:!h}))},toggleFullscreen:k,undoChanges:M,saveChanges:()=>o(),hasUnsavedChanges:!s,recordingToggleChange:m,isDelaySupported:r})})]})},TextArea=styled.textarea`
  box-sizing: border-box;
  background: var(--bg_control);
  padding: 5px 10px;
...
`,UsbErrorWebHIDLink=styled.a`
  text-decoration: underline;
  color: var(--color_label-highlighted);
`,timeoutRepeater=(e,t,o=0)=>()=>setTimeout(()=>{e(),o>0&&timeoutRepeater(e,t,o-1)()},t),Home=e=>{const{hasHIDSupport:t}=e,o=useAppDispatch();useAppSelector(getSelectedKey),useAppSelector(getSelectedDefinition),useAppSelector(getConnectedDevices),useAppSelector(getSelectedLayerIndex),useAppSelector(getSelectedKeyDefinitions),useAppSelector(getDisableFastRemap),useAppSelector(getBasicKeyToByte);const n=useAppSelector(getSelectedKeyboardAPI),r=timeoutRepeater(()=>{o(reloadConnectedDevices())},500,1),s=reactExports.createRef();return reactExports.useEffect(()=>{if(t)return s.current&&s.current.focus(),startMonitoring(),usbDetect.on("change",r),o(loadSupportedIds()),()=>{usbDetect.off("change",r)}},[]),reactExports.useEffect(()=>{o(updateSelectedKey(null))},[n]),!t&&!OVERRIDE_HID_CHECK?jsx(ErrorHome,{ref:s,tabIndex:0,children:jsxs(UsbError,{children:[jsx(UsbErrorIcon,{children:"❌"}),jsx(UsbErrorHeading,{children:"USB Detection Error"}),jsxs("p",{children:["Looks like there was a problem getting USB detection working. Right now, we only support"," ",jsx(UsbErrorWebHIDLink,{href:"https://caniuse.com/?search=webhid",target:"_blank",children:"browsers that have WebHID enabled"}),", so make sure yours is compatible before trying again."]})]})}):jsx(Fragment,{children:e.children})},cubeySrc="/via-col-vento-dev/assets/cubey-495d68a6.glb",glbSrc="/via-col-vento-dev/assets/keyboard_components-1a09821a.glb",useSize=e=>{const[t,o]=reactExports.useState();return reactExports.useLayoutEffect(()=>{e.current&&o(e.current.getBoundingClientRect())},[e]),useResizeObserver(e,n=>o(n.contentRect)),t};var DisplayMode=(e=>(e[e.Test=1]="Test",e[e.Configure=2]="Configure",e[e.Design=3]="Design",e[e.ConfigureColors=4]="ConfigureColors",e))(DisplayMode||{}),KeycapState=(e=>(e[e.Pressed=1]="Pressed",e[e.Unpressed=2]="Unpressed",e))(KeycapState||{});const useColorPainter=(e,t)=>{const o=useAppSelector(getSelectedConnectedDevice),n=useAppSelector(getSelectedKeyboardAPI),r=useAppSelector(getSelectedCustomMenuData)||{__perKeyRGB:[]},[s,a]=reactExports.useState([]);reactExports.useEffect(()=>{const c=r.__perKeyRGB??[],d=(e.find(u=>"li"in u)?e.map(u=>u.li??-1):[]).map(u=>{const C=c[u??-1];if(C)return getHSVFrom256(C)});a(d)},[r.__perKeyRGB&&r.__perKeyRGB.length,e]);const i=reactExports.useCallback((c,l)=>{if(c.buttons===1&&n){const d=Math.round(t[0]*255/360),u=Math.round(t[1]*255),C=e[l].li;C!==void 0&&(n.setPerKeyRGBMatrix(C,d,u),n.commitCustomMenu(0),a(_=>(_[l]=t,[..._])))}},[a,t,e,o]);return{keyColors:s,onKeycapPointerDown:i,onKeycapPointerOver:i}},Heart=React.memo(e=>{const t=Math.atan(2/e.caseWidth),o=(80+-30)/2,n=2,r=1,a=-(-e.caseWidth-r*2-n*2)/Math.cos(t),i=.1*a/22,c=95,l=95*i,d=(a-l)/2,u=reactExports.useMemo(()=>{const _=new Shape;return _.moveTo(i*(25-o),i*(25-c)),_.bezierCurveTo(i*(25-o),i*(25-c),i*(20-o),i*(0-c),i*(0-o),i*(0-c)),_.bezierCurveTo(i*(-30-o),i*(0-c),i*(-30-o),i*(35-c),i*(-30-o),i*(35-c)),_.bezierCurveTo(i*(-30-o),i*(55-c),i*(-10-o),i*(77-c),i*(25-o),i*(95-c)),_.bezierCurveTo(i*(60-o),i*(77-c),i*(80-o),i*(55-c),i*(80-o),i*(35-c)),_.bezierCurveTo(i*(80-o),i*(35-c),i*(80-o),i*(0-c),i*(50-o),i*(0-c)),_.bezierCurveTo(i*(35-o),i*(0-c),i*(25-o),i*(25-c),i*(25-o),i*(25-c)),_},[e.caseWidth,e.caseHeight,e.color]),C={depth:4,bevelEnabled:!0,bevelSegments:10,bevelSize:1,bevelThickness:1};return jsxs("mesh",{position:[-a+d,n*2+r*2+e.caseHeight/2,0],scale:1,rotation:[Math.PI/2,t,Math.PI/2],children:[jsx("extrudeGeometry",{attach:"geometry",args:[u,C]}),jsx("meshPhongMaterial",{color:e.color,transparent:!0,opacity:1})]})},shallowEqual),makeShape2=e=>{const t=Math.tan(Math.PI*7.5/180),o=10,n=o+t*e,r=e/2,s=new Shape;let a=2,i=Math.PI/2;return s.moveTo(-n,r),s.absarc(-n-a,r-a,a,i*1+i,i*1,!0),s.absarc(-a,r,a,i*1,i*1-i,!0),s.absarc(-a,-r,a,i*3+i,i*3,!0),s.absarc(-o-a,-r-a,a,i*2+i,i*2,!0),s},Case$1=React.memo(e=>{const t=useAppSelector(getSelectedTheme),o=reactExports.useMemo(()=>t[dist.KeyColorType.Accent].c,[t]),n="#212020",r=reactExports.useMemo(()=>t[dist.KeyColorType.Accent].t,[t]),s=e.width*KeycapMetric.keyXPos-KeycapMetric.keyXSpacing,a=KeycapMetric.keyYPos*e.height-KeycapMetric.keyYSpacing,i=4,c=s+i*1,l=s+i*2.5,[d,u]=reactExports.useMemo(()=>[a+i,a+i*2].map(makeShape2),[a]),C=1,_=10,K=10+Math.tan(Math.PI*7.5/180)*(a+i*2);return jsxs("group",{scale:1,"position-z":-C*2,"rotation-y":-Math.PI/2,children:[jsx(Heart,{caseWidth:K,caseHeight:a,color:r}),jsxs("mesh",{position:[-C,0,-l/2],castShadow:!0,children:[jsx("extrudeGeometry",{attach:"geometry",args:[u,{depth:l,bevelEnabled:!0,bevelSize:C,bevelThickness:C,bevelSegments:_}]}),jsx("meshPhongMaterial",{color:o,shininess:100,reflectivity:1,specular:getDarkenedColor(o,.2)})]}),jsxs("mesh",{position:[0,0,-c/2],castShadow:!0,children:[jsx("extrudeGeometry",{attach:"geometry",args:[d,{depth:c,bevelEnabled:!0,bevelSize:C/2,bevelThickness:C,bevelSegments:_}]}),jsx("meshPhongMaterial",{color:n,shininess:100,reflectivity:1,specular:getDarkenedColor(o,.2)})]})]})});function useSkipFontCheck(){const[e,t]=reactExports.useState(!1),o=reactExports.useCallback(()=>{t(!1)},[]),n=reactExports.useCallback(()=>{t(!0)},[]);return reactExports.useEffect(()=>{document.fonts.load("Fira Sans").then(o,n)},[]),e}function getKeycapSharedProps(e,t,o,n,r,s,a){const{position:i,rotation:c,scale:l,color:d,idx:u,onClick:C,onPointerDown:_,onPointerOver:h}=n.coords[t],p=e.ei!==void 0;return{mode:o.mode,position:i,rotation:c,scale:getScale(e,l),textureWidth:e.w,textureHeight:e.h,textureOffsetX:e.w2?Math.abs(e.w2-e.w):0,color:d,shouldRotate:p,onPointerDown:_,onPointerOver:h,keyState:o.pressedKeys?o.pressedKeys[t]:-1,disabled:!o.selectable,selected:t===r,idx:u,label:s[t],onClick:C,key:n.indices[t],skipFontCheck:a}}const getKeysKeysIndices=e=>(t,o)=>{const n=t.ei!==void 0;return`${e}-${o}-${t.w}-${t.h}-${n}`};function getLabels(e,t,o,n){return e.matrixKeycodes.length?e.keys.map((r,s)=>getLabel(e.matrixKeycodes[s],r.w,t,e.definition,o,n)):[]}function getKeysKeys(e,t,o,n){const{keys:r}=e,{rowMap:s}=getKeyboardRowPartitions(r),a=r.map(dist.getBoundingBox),[i,c]=[Math.min(...a.map(d=>d.xStart)),Math.min(...a.map(d=>d.yStart))],l=r.map(d=>{const u={...d};return i<0&&(u.x=u.x-i),c<0&&(u.y=u.y-c),u}).map(calculatePointPosition);return{indices:r.map(getKeysKeysIndices(e.definition.vendorProductId)),coords:r.map((d,u)=>{const[C,_]=l[u],h=d.r*(2*Math.PI)/360,p=KeycapMetric.keyXSpacing/KeycapMetric.keyWidth,K=KeycapMetric.keyYSpacing/KeycapMetric.keyHeight,y=(1+p)*(d.w2||d.w)-p,g=d.h*(1+K)-K,m=getMeshName(d,s[getKeyId(d)],!1),S=e.keyColors?u:d.color,M=t[S];return{position:n(C+i,_+c),rotation:[0,0,-h],scale:[y,g,1],color:M,meshKey:m,idx:u,onClick:(b,f)=>{b.stopPropagation(),o(updateSelectedKey(f))},onPointerDown:e.onKeycapPointerDown,onPointerOver:e.onKeycapPointerOver}})}}function fitTextToWidth(e,t,o,n=32,r=8,s="Arial",a=!0){let i=n,c=1/0;for(let l=0;l<10;l++){e.font=`${a?"bold ":""}${i}px ${s}`;const u=e.measureText(t).width;if(u<=o||u===c)break;const C=o/u;i=Math.max(Math.floor(i*C),r),c=u}return i}const getMacroData$1=({macroExpression:e,label:t})=>t&&t.length>15?t:e&&e.length?e:null,paintEncoder=(e,[t,o],n,r)=>{const[i,c]=[512*t,512*o];e.width=i,e.height=c;const l=e.getContext("2d"),d=2.6;if(l){l.fillStyle=n,l.clearRect(0,0,e.width,e.height),l.fillRect(0,0,e.width,e.height),l.fill(),l.fillStyle=r;const u=.4*i/d;l.ellipse(.5*i/d,2.1*c/d,u,u,Math.PI/4,0,2*Math.PI),l.fill()}},paintKeycapLabel$1=(e,t,o,n)=>{const r=e.getContext("2d");if(r==null)return;const s="Fira Sans, Arial Rounded MT, Arial Rounded MT Bold, Arial",a={x:.015,y:.02},i={x:.01,y:-.01},c={x:.01,y:.02};if(r.beginPath(),r.moveTo(t.bl.x*e.width,(1-t.bl.y)*e.height),r.lineTo(t.bl.x*e.width,(1-t.tr.y)*e.height),r.lineTo(t.tr.x*e.width,(1-t.tr.y)*e.height),r.lineTo(t.tr.x*e.width,(1-t.bl.y)*e.height),r.lineTo(t.bl.x*e.width,(1-t.bl.y)*e.height),r.clip(),r.fillStyle=o,n!==void 0){if(n.topLabel&&n.bottomLabel){let l=52,d=.75*l/e.height,u=n.offset[0]*d,C=n.offset[1]*d;r.font=`bold ${l}px ${s}`,r.fillText(n.topLabel,(t.bl.x+a.x)*e.width,(1-(t.tr.y-d-a.y-u))*e.height),r.fillText(n.bottomLabel,(t.bl.x+a.x)*e.width,(1-(t.bl.y+a.y+C))*e.height)}else if(n.centerLabel){let l=37.5*n.size,d=.75*l/e.height,u=(t.tr.y+t.bl.y)/2;const C=!0,_=(t.tr.x-(t.bl.x+i.x))*e.width,h=30;return fitTextToWidth(r,n.label,_,l,h,s,C),r.fillText(n.label,(t.bl.x+i.x)*e.width,(1-(u-.5*d-i.y))*e.height),r.measureText(n.centerLabel).width>_}else if(typeof n.label=="string"){let l=75,d=.75*l/e.height;r.font=`bold ${l}px ${s}`,r.fillText(n.label,(t.bl.x+c.x)*e.width,(1-(t.tr.y-d-c.y))*e.height)}}},calculateTextureRects=(e,t,o,n,r)=>{const s=.3846153846153846,c=.445/19.05*s;let l=Math.min(2.75,o),d=Math.min(2.75,n);(e>1||t>1)&&(l=1,d=1);let u={bl:{x:c,y:c},tr:{x:l*s-c,y:d*s-c}},C={bl:{x:u.bl.x+.07,y:u.bl.y+.08},tr:{x:u.tr.x-.07,y:u.tr.y-.0146}};return r>0&&(C.bl.x+=r*s,C.tr.x+=r*s,u.bl.x+=r*s,u.tr.x+=r*s),{keycapRect:u,faceRect:C}},paintKeycap$1=(e,[t,o],n,r,s,a,i,c)=>{const l=calculateTextureRects(t,o,n,r,c),d=512;e.width=d*t,e.height=d*o;const u=e.getContext("2d");if(u!=null)return u.fillStyle=s,u.fillRect(0,0,e.width,e.height),paintKeycapLabel$1(e,l.faceRect,a,i)},Keycap$1=React.memo(e=>{const{label:t,scale:o,color:n,onClick:r,selected:s,disabled:a,mode:i,rotation:c,keyState:l,shouldRotate:d,keycapGeometry:u,textureOffsetX:C,textureWidth:_,textureHeight:h,onPointerOver:p,onPointerDown:K,idx:y}=e,g=reactExports.useRef(),m=t&&getMacroData$1(t),[S,M]=reactExports.useState(!1),[b,f]=reactExports.useState(!1),T=reactExports.useRef(),D=reactExports.useRef(document.createElement("canvas")),v=React.useCallback(()=>{if(D.current&&n){if(d)paintEncoder(D.current,[o[0],o[1]],n.c,n.t);else{const U=paintKeycap$1(D.current,[o[0],o[1]],_,h,n.c,n.t,t,C);M(!!U)}T.current.needsUpdate=!0}},[D.current,_,t&&t.key,o[0],o[1],n&&n.t,n&&n.c,d]);reactExports.useEffect(v,[t&&t.key,n&&n.c,n&&n.t]);const j=useSpring({config:{duration:800},from:{x:0,y:"#f4a0a0"},loop:s?{reverse:!0}:!1,to:{x:100,y:"#b49999"}});let k=u.boundingBox.max.z;const[A,R]=[k,k+8],I=DisplayMode.Test===i?TestKeyState.KeyDown===l?KeycapState.Pressed:KeycapState.Unpressed:b||s?KeycapState.Unpressed:KeycapState.Pressed,[P,w]=I===KeycapState.Pressed?[A,c[2]]:[R,c[2]+Math.PI*Number(d)],H=l===TestKeyState.KeyUp,$=DisplayMode.Test===i?I===KeycapState.Unpressed?H?"palevioletred":"lightgrey":"pink":(I===KeycapState.Unpressed,"lightgrey"),{z:Y,b:E,rotateZ:B,tooltipScale:O}=useSpring({config:{duration:100},z:P,b:$,rotateZ:w,tooltipScale:b?1:0}),[L,N,F,W]=reactExports.useMemo(()=>{const U=()=>{};return a?[U,U,U,U]:e.mode===DisplayMode.ConfigureColors?[U,G=>{p&&p(G,y)},U,G=>{K&&K(G,y)}]:[G=>r(G,y),G=>{p&&p(G,y),f(!0)},()=>f(!1),G=>{K&&K(G,y)}]},[a,r,K,p,f,y,i]),Q=animated.meshPhongMaterial;return jsxs(Fragment,{children:[jsx(animated.mesh,{...e,ref:g,"position-z":Y,"rotation-z":B,onClick:L,onPointerDown:W,onPointerOver:N,onPointerOut:F,geometry:u,children:jsx(Q,{attach:"material",color:s?j.y:E,children:jsx("canvasTexture",{ref:T,attach:"map",image:D.current})})}),(m||(t==null?void 0:t.tooltipLabel))&&jsx(React.Suspense,{fallback:null,children:jsx(animated.group,{position:e.position,"position-z":20,scale:O,children:jsx(Html,{transform:!0,style:{pointerEvents:"none"},children:jsx(KeycapTooltip,{children:m||t&&t.tooltipLabel})})})})]})},shallowEqual),getSRGBArray=e=>e.map(([t,o])=>{const n=getRGB({hue:Math.round(255*t/360),sat:Math.round(255*o)}),r=`#${new Color(n).convertSRGBToLinear().getHexString()}`;return{c:r,t:r}}),getPosition$1=(e,t)=>[KeycapMetric.keyXPos*e/CSSVarObject.keyXPos,-t*KeycapMetric.keyYPos/CSSVarObject.keyYPos,0],KeyGroup$1=e=>{const t=useAppDispatch(),o=useGLTF(glbSrc,!0).scene,n=useAppSelector(getSelectedKey),r=useAppSelector(getSelectedSRGBTheme),s=useAppSelector(getExpressions),a=useSkipFontCheck(),i=e.keyColors?getSRGBArray(e.keyColors):r,{basicKeyToByte:c,byteToKey:l}=useAppSelector(getBasicKeyToByte),d=useAppSelector(m=>m.macros),{keys:u,selectedKey:C}=e,_=C===void 0?n:C,h=reactExports.useMemo(()=>getKeysKeys(e,i,t,getPosition$1),[u,i,e.onKeycapPointerDown,e.onKeycapPointerOver]),p=reactExports.useMemo(()=>getLabels(e,s,c,l),[u,e.matrixKeycodes,d,e.definition]),{width:K,height:y}=calculateKeyboardFrameDimensions(u),g=reactExports.useMemo(()=>e.keys.map((m,S)=>{const{meshKey:M}=h.coords[S],{key:b,...f}=getKeycapSharedProps(m,S,e,h,_,p,a);return m.d?null:jsx(Keycap$1,{keycapGeometry:(o.getObjectByName(M)||o.getObjectByName("K-R1-100")).geometry,...f},b)}),[u,_,p,e.pressedKeys,e.selectable,i,e.definition.vendorProductId,a]);return jsx("group",{scale:1,position:[(-K*KeycapMetric.keyXPos+KeycapMetric.keyXSpacing)/2,(KeycapMetric.keyYPos*y-KeycapMetric.keyYSpacing)/2,0],children:g})},generateRowColArray=(e,t,o)=>{const n=e.filter(a=>a.ei===void 0&&!a.d),r=n.reduce((a,i)=>(a[i.row][i.col]=calculatePointPosition(i),a),Array(t).fill(0).map(()=>Array(o).fill(0))).map(a=>a.sort((i,c)=>i[0]-c[0])),s=n.reduce((a,i)=>(a[i.col][i.row]=calculatePointPosition(i),a),Array(o).fill(0).map(()=>Array(t).fill(0))).map(a=>a.sort((i,c)=>i[1]-c[1]));return{rowKeys:r,colKeys:s}},MatrixLines$1=({keys:e,rows:t,cols:o,width:n,height:r})=>{const[s,a]=["lightpink","lightgrey"],{rowKeys:i,colKeys:c}=generateRowColArray(e,t,o);return jsx("group",{scale:.35,rotation:[Math.PI,0,0],position:[-n*KeycapMetric.keyXPos/2,(r+.4)*KeycapMetric.keyYPos/2,11],children:jsxs(Segments,{lineWidth:1,children:[i.flatMap(l=>{const d=l.filter(u=>u);return d.length>=2?d.reduce((u,C,_)=>u.prev===null?{res:[],prev:C}:{res:[...u.res,jsx(Segment,{start:[u.prev[0],u.prev[1],0],end:[C[0],C[1],0],color:s},`row-${_}`)],prev:C},{res:[],prev:null}).res:[]}),c.flatMap(l=>{const d=l.filter(u=>u);return d.length>=2?d.reduce((u,C,_)=>u.prev===null?{res:[],prev:C}:{res:[...u.res,jsx(Segment,{start:[u.prev[0],u.prev[1],0],end:[C[0],C[1],0],color:a},`col-${_}`)],prev:C},{res:[],prev:null}).res:[]})]})},`${t}-${o}-${n}-${r}`)},KeyboardCanvas$1=e=>{const{containerDimensions:t,shouldHide:o,...n}=e,{width:r,height:s}=reactExports.useMemo(()=>calculateKeyboardFrameDimensions(n.keys),[n.keys]),[a,i]=reactExports.useState(!1),{verticalPostion:c,tilt:l}=useSpring({config:{tension:35,friction:5,mass:.3},verticalPostion:a?1:-3,tilt:a?-.15:0});reactExports.useEffect(()=>{const m=document.querySelector("canvas");m&&(m.addEventListener("mouseenter",()=>{i(!0)}),m.addEventListener("mouseleave",()=>{i(!1)}))},[]);const d=t.height,u=t.width,C=60,_=(CSSVarObject.keyWidth+CSSVarObject.keyXSpacing)*r-CSSVarObject.keyXSpacing+C*2,h=(CSSVarObject.keyHeight+CSSVarObject.keyYSpacing)*s-CSSVarObject.keyYSpacing+C*2,p=u/_,K=d/h,y=Math.min(p,K),g=Math.max(1,y)||1;return jsx("group",{position:[0,-0,-19],scale:.01*g,visible:!o,children:jsx(KeyboardCanvasContent$1,{...n,width:r,height:s,verticalPostion:c,tilt:l})})},KeyboardCanvasContent$1=React.memo(e=>{const{matrixKeycodes:t,keys:o,definition:n,pressedKeys:r,mode:s,showMatrix:a,selectable:i,width:c,height:l,verticalPostion:d,tilt:u}=e;return jsx(animated.group,{"position-y":d,"rotation-x":u,children:jsxs(PresentationControls,{enabled:e.mode!==DisplayMode.ConfigureColors,global:!0,snap:!0,speed:1,zoom:1,polar:[-Math.PI/10,Math.PI/10],azimuth:[-Math.PI/16,Math.PI/16],config:{mass:1,tension:170,friction:26},children:[jsx(Case$1,{width:c,height:l}),jsx(KeyGroup$1,{...e,keys:o,mode:s,matrixKeycodes:t,selectable:i,definition:n,pressedKeys:r}),a&&jsx(MatrixLines$1,{keys:o,rows:n.matrix.rows,cols:n.matrix.cols,width:c,height:l})]})})},shallowEqual),CaseGroup=styled.div``,OuterCase=styled.div`
...
`,EncoderKey=e=>jsx(EncoderKeyContainer,{onClick:e.onClick,style:e.style,children:jsx(EncoderKeyContent2,{$size:e.size&&+e.size,$innerPadding:5*e.size/52})}),getMacroData=({macroExpression:e,label:t})=>t&&t.length>15?t:e&&e.length?e:null,paintKeycapLabel=(e,t,o)=>{const n=e.getContext("2d");if(n==null)return;const r=devicePixelRatio,[s,a]=[e.width,e.height];e.width=s*r,e.height=a*r,e.style.width=`${s}px`,e.style.height=`${a}px`,n.scale(r,r);const i="Fira Sans, Arial Rounded MT, Arial Rounded MT Bold, Arial",c={x:4,y:4},l={x:4,y:4},d={x:3,y:0},u={x:4,y:4};if(n.beginPath(),n.moveTo(0,0),n.lineTo(e.width,0),n.lineTo(e.width,e.height),n.lineTo(0,e.height),n.lineTo(0,0),n.clip(),n.fillStyle=t,o!==void 0){if(o.topLabel&&o.bottomLabel){let C=16,_=.75*C,h=o.offset[0]*_,p=o.offset[1]*_;n.font=`bold ${C}px ${i}`,n.fillText(o.topLabel,c.x,c.y+h+_),n.fillText(o.bottomLabel,l.x,a-l.y-p)}else if(o.centerLabel){let C=13*o.size,_=.75*C,h=a/2;const p=!0,K=s-d.x,y=10;return fitTextToWidth(n,o.label,K,C,y,i,p),n.fillText(o.label,d.x,h+.5*_),n.measureText(o.centerLabel).width>K}else if(typeof o.label=="string"){let C=22,_=.75*C;n.font=`bold ${C}px ${i}`,n.fillText(o.label,u.x,u.y+_)}}},paintKeycap=(e,t,o,n,r)=>{const[s,a]=[CSSVarObject.keyWidth,CSSVarObject.keyHeight];if(e.width=s*t-CSSVarObject.faceXPadding.reduce((c,l)=>c+l,0),e.height=a*o-CSSVarObject.faceYPadding.reduce((c,l)=>c+l,0),e.getContext("2d")!=null)return paintKeycapLabel(e,n,r)},Keycap=React.memo(e=>{const{label:t,scale:o,color:n,selected:r,disabled:s,mode:a,rotation:i,keyState:c,shouldRotate:l,textureWidth:d,textureHeight:u,skipFontCheck:C,idx:_}=e,h=t&&getMacroData(t),[p,K]=reactExports.useState(!1),[y,g]=reactExports.useState(!1),m=reactExports.useRef(null),S=React.useCallback(()=>{if(m.current&&n&&t&&(document.fonts.check('bold 16px "Fira Sans"',t.label)||C)){const P=paintKeycap(m.current,d,u,n.t,t);K(!!P)}},[m.current,d,t&&t.key,o[0],o[1],n&&n.t,n&&n.c,l]);reactExports.useEffect(S,[t&&t.key,C,n&&n.c,n&&n.t]),reactExports.useEffect(()=>(document.fonts.addEventListener("loadingdone",S),()=>{document.fonts.removeEventListener("loadingdone",S)}),[]);const[M,b]=[-8,0],f=DisplayMode.Test===a?TestKeyState.KeyDown===c?KeycapState.Pressed:KeycapState.Unpressed:y||r?KeycapState.Pressed:KeycapState.Unpressed,[T]=f===KeycapState.Pressed?[M,i[2]]:[b,i[2]+Math.PI*Number(l)],D=c===TestKeyState.KeyUp,v=DisplayMode.Test===a?f===KeycapState.Unpressed?D?"mediumvioletred":"lightgrey":"mediumvioletred":(f===KeycapState.Unpressed,"lightgrey"),j=f===KeycapState.Unpressed?D?.4:0:.6,[k,A,R,I]=reactExports.useMemo(()=>{const P=()=>{};return s?[P,P,P,P]:e.mode===DisplayMode.ConfigureColors?[P,w=>{e.onPointerOver&&e.onPointerOver(w,_)},P,w=>{e.onPointerDown&&e.onPointerDown(w,_)}]:[w=>e.onClick(w,_),w=>{e.onPointerOver&&e.onPointerOver(w,_),g(!0)},()=>g(!1),w=>{e.onPointerDown&&e.onPointerDown(w,_)}]},[s,e.onClick,e.onPointerDown,e.onPointerOver,g,_,a]);return l?jsx(EncoderKey,{onClick:k,size:d*CSSVarObject.keyWidth,style:{transform:`translate(${e.position[0]-(CSSVarObject.keyWidth*d-CSSVarObject.keyWidth)/2}px,${d*(CSSVarObject.keyHeight-CSSVarObject.keyWidth)/2+e.position[1]-(CSSVarObject.keyHeight*u-CSSVarObject.keyHeight)/2}px) rotate(${-e.rotation[2]}rad)`,borderRadius:3,color:e.color.c}}):e.clipPath?jsx(ComboKeycap,{...e,onClick:k,onPointerDown:I,onPointerOver:A,onPointerOut:R,keycapZ:T,keycapOpacity:j,keycapColor:v,canvasRef:m,macroData:h,overflowsTexture:p,style:{transform:`translate(${CSSVarObject.keyWidth/2+e.position[0]-(CSSVarObject.keyXPos*d-CSSVarObject.keyXSpacing)/2}px,${CSSVarObject.keyHeight/2+e.position[1]-(CSSVarObject.keyYPos*u-CSSVarObject.keyYSpacing)/2}px) rotate(${-e.rotation[2]}rad)`,width:d*CSSVarObject.keyXPos-CSSVarObject.keyXSpacing,height:u*CSSVarObject.keyYPos-CSSVarObject.keyYSpacing}}):jsx(Fragment,{children:jsxs(KeycapContainer,{onClick:k,onPointerDown:I,onPointerOver:A,onPointerOut:R,style:{transform:`translate(${CSSVarObject.keyWidth/2+e.position[0]-(CSSVarObject.keyXPos*d-CSSVarObject.keyXSpacing)/2}px,${CSSVarObject.keyHeight/2+e.position[1]-(CSSVarObject.keyYPos*u-CSSVarObject.keyYSpacing)/2}px) rotate(${-e.rotation[2]}rad)`,width:d*CSSVarObject.keyXPos-CSSVarObject.keyXSpacing,height:u*CSSVarObject.keyYPos-CSSVarObject.keyYSpacing,cursor:s?"initial":"pointer"},children:[jsxs(GlowContainer,{$selected:r,style:{animation:s?"initial":r?".75s infinite alternate select-glow":"",background:getDarkenedColor(e.color.c,.8),transform:`perspective(100px) translateZ(${T}px)`,borderRadius:3,width:d*CSSVarObject.keyXPos-CSSVarObject.keyXSpacing,height:u*CSSVarObject.keyYPos-CSSVarObject.keyYSpacing},children:[DisplayMode.Test===a?jsx(TestOverlay,{style:{background:v,opacity:j}}):null,jsx(CanvasContainer,{style:{borderRadius:4,background:e.color.c,height:"100%"},children:jsx("canvas",{ref:m,style:{}})})]}),(h||(t==null?void 0:t.tooltipLabel))&&jsx(TooltipContainer,{$rotate:i[2],children:jsx(Keycap2DTooltip,{children:h||t&&t.tooltipLabel})})]})})},shallowEqual),GlowContainer=styled.div`
  box-sizing: border-box;
  padding: 2px 6px 10px 6px;
  transition: transform 0.2s ease-out;
  box-shadow: inset -1px -1px 0 rgb(0 0 0 / 20%),
...
`,getPosition=(e,t)=>[e-CSSVarObject.keyWidth/2,t-CSSVarObject.keyHeight/2,0],getRGBArray=e=>e.map(([t,o])=>{const n=getRGB({hue:Math.round(255*t/360),sat:Math.round(255*o)}),r=`#${new Color(n).getHexString()}`;return{c:r,t:r}}),KeyGroup=e=>{const t=useAppDispatch(),o=useAppSelector(getSelectedKey),n=useAppSelector(getSelectedTheme),r=useAppSelector(getExpressions),s=useSkipFontCheck(),a=e.keyColors?getRGBArray(e.keyColors):n,{basicKeyToByte:i,byteToKey:c}=useAppSelector(getBasicKeyToByte),l=useAppSelector(g=>g.macros),{keys:d,selectedKey:u}=e,C=u===void 0?o:u,_=reactExports.useMemo(()=>getKeysKeys(e,a,t,getPosition),[d,a,e.onKeycapPointerDown,e.onKeycapPointerOver]),h=reactExports.useMemo(()=>getLabels(e,r,i,c),[d,e.matrixKeycodes,l,e.definition]),{width:p,height:K}=calculateKeyboardFrameDimensions(d),y=reactExports.useMemo(()=>e.keys.map((g,m)=>g.d?null:jsx(Keycap,{...getComboKeyProps(g),...getKeycapSharedProps(g,m,e,_,C,h,s)})),[d,C,h,e.pressedKeys,e.selectable,a,e.definition.vendorProductId,s]);return jsx(KeyGroupContainer,{height:K,width:p,style:{pointerEvents:e.selectable?"all":"none"},children:y})},Matrix=({rowKeys:e,colKeys:t})=>jsxs(SVG,{style:{position:"absolute",top:CSSVarObject.insideBorder,left:CSSVarObject.insideBorder},children:[e.map((o,n)=>jsx(RowLine,{points:o.map(r=>(r||[]).join(",")).join(" ")},n)),t.map((o,n)=>jsx(ColLine,{points:o.map(r=>(r||[]).join(",")).join(" ")},n))]}),SVG=styled.svg`
  transform: rotateZ(0);
  width: 100%;
  height: 100%;
...
`,ColLine=styled.polyline`
  ...
  stroke-opacity: 0.4;
  stroke-linecap: round;
`,MatrixLines=({keys:e,rows:t,cols:o,width:n,height:r})=>{const{rowKeys:s,colKeys:a}=generateRowColArray(e,t,o);return jsx(Matrix,{rowKeys:s,colKeys:a})},KeyboardCanvas=e=>{const{containerDimensions:t,shouldHide:o,...n}=e,{width:r,height:s}=reactExports.useMemo(()=>calculateKeyboardFrameDimensions(n.keys),[n.keys]),a=t.height,i=t.width,c=60,l=(CSSVarObject.keyWidth+CSSVarObject.keyXSpacing)*r-CSSVarObject.keyXSpacing+c*2,d=(CSSVarObject.keyHeight+CSSVarObject.keyYSpacing)*s-CSSVarObject.keyYSpacing+c*2,u=i/l,C=a/d,_=Math.min(u,C),h=Math.max(1,_)||1;return jsx("div",{style:{transform:`scale(${h}, ${h})`,opacity:o?0:1,position:"absolute",pointerEvents:o?"none":"all"},children:jsx(KeyboardCanvasContent,{...n,width:r,height:s})})},KeyboardGroup$2=styled.div`
  position: relative;
`,KeyboardCanvasContent=React.memo(e=>{const{matrixKeycodes:t,keys:o,definition:n,pressedKeys:r,mode:s,showMatrix:a,selectable:i,width:c,height:l}=e;return jsxs(KeyboardGroup$2,{children:[jsx(Case,{width:c,height:l}),jsx(KeyGroup,{...e,keys:o,mode:s,matrixKeycodes:t,selectable:i,definition:n,pressedKeys:r}),a&&jsx(MatrixLines,{keys:o,rows:n.matrix.rows,cols:n.matrix.cols,width:c,height:l})]})},shallowEqual),getKeyboardCanvas=e=>e==="2D"?KeyboardCanvas:KeyboardCanvas$1,ConfigureKeyboard=e=>{const{selectable:t,dimensions:o}=e,n=useAppSelector(p=>getSelectedKeymap(p)||[]),r=useAppSelector(getSelectedKeyDefinitions),s=useAppSelector(getSelectedDefinition),a=useAppSelector(getShowKeyPainter),i=useAppSelector(getSelectedPaletteColor),{keyColors:c,onKeycapPointerDown:l,onKeycapPointerOver:d}=useColorPainter(r,i),[u,C]=reactExports.useMemo(()=>c&&r?[r.filter((p,K)=>c[K]&&c[K].length),c.filter(p=>p&&p.length)]:[null,null],[r,c]);if(!s||!o)return null;const _=(u==null?void 0:u.length)&&(C==null?void 0:C.length),h=getKeyboardCanvas(e.nDimension);return jsxs(Fragment,{children:[jsx(h,{matrixKeycodes:n,keys:r,selectable:!!t,definition:s,containerDimensions:o,mode:DisplayMode.Configure,shouldHide:a}),_?jsx(h,{matrixKeycodes:n,keys:u,selectable:a,definition:s,containerDimensions:o,mode:DisplayMode.ConfigureColors,keyColors:C,onKeycapPointerDown:l,onKeycapPointerOver:d,shouldHide:!a}):null]})},EMPTY_ARR$1=[],DesignKeyboard=e=>{const{containerDimensions:t,showMatrix:o,definition:n,selectedOptionKeys:r}=e,{keys:s,optionKeys:a}=n.layouts;if(!t)return null;const i=reactExports.useMemo(()=>a?Object.entries(a).flatMap(([d,u])=>{const C=parseInt(d);return r[C]?u[r[C]]:u[0]}):[],[a,r]),c=reactExports.useMemo(()=>[...s,...i],[s,i]),l=getKeyboardCanvas(e.nDimension);return jsx(l,{matrixKeycodes:EMPTY_ARR$1,keys:c,selectable:!1,definition:n,containerDimensions:t,mode:DisplayMode.Design,showMatrix:o})},Design=e=>{const t=Object.values(useAppSelector(getCustomDefinitions)),o=useAppSelector(getDesignDefinitionVersion),n=useAppSelector(getSelectedDefinitionIndex),r=useAppSelector(getDesignSelectedOptionKeys),s=useAppSelector(getShowMatrix),a=reactExports.useMemo(()=>t.filter(c=>c[o]),[t,o]),i=a[n]&&a[n][o];return i&&jsx(DesignKeyboard,{containerDimensions:e.dimensions,definition:i,selectedOptionKeys:r,showMatrix:s,nDimension:e.nDimension})},useGlobalKeys=e=>{const t=!e,o=reactExports.useState({}),[n,r]=o;function s(i){i.preventDefault(),!t&&!i.repeat&&n[getIndexByEvent(i)??-1]!==TestKeyState.KeyDown&&r(c=>({...c,[getIndexByEvent(i)]:TestKeyState.KeyDown}))}const a=i=>{i.preventDefault(),!t&&n[getIndexByEvent(i)]!==TestKeyState.KeyUp&&r(c=>({...c,[getIndexByEvent(i)]:TestKeyState.KeyUp}))};return reactExports.useEffect(()=>(e&&(window.addEventListener("keydown",s),window.addEventListener("keyup",a)),()=>{window.removeEventListener("keydown",s),window.removeEventListener("keyup",a)}),[e]),o},invertTestKeyState=e=>e===TestKeyState.KeyDown?TestKeyState.KeyUp:TestKeyState.KeyDown,useMatrixTest=(e,t,o,n)=>{const r=reactExports.useState([]),[,s]=r,a=useDispatch(),i=reactExports.useRef(e);reactExports.useEffect(()=>{let d=[];const u=()=>{i.current=!1},C=async(_,h,p,K)=>{if(e&&_&&p){const{cols:y,rows:g}=p.matrix,m=Math.ceil(y/8),S=Math.floor(28/m);try{let M=[];for(let f=0;f<g;f+=S){const T=Math.min(g*m-M.length,m*S);M.push(...await _.getKeyboardValue(KeyboardValue.SWITCH_MATRIX_STATE,h>=12?[f]:[],T))}if(!M.some((f,T)=>f^(K[T]||0))){await _.timeout(20),i.current&&C(_,h,p,K);return}s(f=>M.reduce((T,D,v)=>{const j=D^(K[v]||0);if(j===0)return T;const k=~~(v/m),A=8*(m-1-v%m);return Array(Math.max(0,Math.min(8,y-A))).fill(0).reduce((R,I,P)=>{const w=y*k+P+A;return R[w]=(j>>P&1)===1?invertTestKeyState(R[w]):R[w],R},T)},Array.isArray(f)&&f.length===g*y?[...f]:Array(g*y).fill(TestKeyState.Initial))),await _.timeout(20),i.current&&C(_,h,p,M)}catch{i.current=!1,a(setTestMatrixEnabled(!1))}}};return e&&t&&o&&n&&(i.current=!0,C(t,o.protocol,n,d)),()=>{u()}},[e,n,t]);const c=d=>{d.preventDefault()},l=d=>{d.preventDefault()};return reactExports.useEffect(()=>(e&&(window.addEventListener("keydown",c),window.addEventListener("keyup",l)),()=>{window.removeEventListener("keydown",c),window.removeEventListener("keyup",l)}),[e]),r},EMPTY_ARR=[],Test=e=>{const t=useAppDispatch(),[o]=useLocation(),n=o==="/test",r=useAppSelector(getSelectedKeyboardAPI),s=useAppSelector(getSelectedConnectedDevice),a=useAppSelector(getSelectedDefinition),i=useAppSelector(getSelectedKeyDefinitions),c=useAppSelector(getIsTestMatrixEnabled),l=useAppSelector(getTestKeyboardSoundsSettings),d=useAppSelector(T=>getSelectedKeymap(T)||[]),[u,C]=useGlobalKeys(!c&&n),[_,h]=useMatrixTest(c&&n,r,s,a),p=reactExports.useCallback(()=>{C(EMPTY_ARR),h(EMPTY_ARR)},[C,h]),K=reactExports.useContext(TestContext);reactExports.useEffect(()=>{K[0].clearTestKeys!==p&&K[1]({clearTestKeys:p})},[K,p]),reactExports.useEffect(()=>{o!=="/test"&&(t(setTestMatrixEnabled(!1)),K[0].clearTestKeys()),o!=="/"&&t(setLayer(0))},[o]);const y=c&&i?i.map(({row:T,col:D})=>a&&_[T*a.matrix.cols+D]):[],g=c?a:fullKeyboardDefinition,m=c?i:fullKeyboardDefinition.layouts.keys;if(!g||typeof g=="string")return null;const S=c?y:u,{partitionedKeys:M}=reactExports.useMemo(()=>getKeyboardRowPartitions(m),[m]),b=c?_:u,f=M.map(T=>T.map(({row:D,col:v})=>b[D*g.matrix.cols+v]));return jsxs(Fragment,{children:[jsx(TestKeyboard,{definition:g,keys:m,pressedKeys:S,matrixKeycodes:c?d:matrixKeycodes,containerDimensions:e.dimensions,nDimension:e.nDimension}),f&&l.isEnabled&&jsx(TestKeyboardSounds,{pressedKeys:f})]})},TestKeyboard=e=>{const{selectable:t,containerDimensions:o,matrixKeycodes:n,keys:r,pressedKeys:s,definition:a,nDimension:i}=e;if(!o)return null;const c=getKeyboardCanvas(i);return jsx(c,{matrixKeycodes:n,keys:r,selectable:!!t,definition:a,pressedKeys:s,containerDimensions:o,mode:DisplayMode.Test})},ZOOM=5.5*.8,Camera=()=>{const{progress:e}=useProgress(),t=useThree(s=>s.camera),[o,n]=[7,7],r=useSpring({config:{duration:800},from:{x:o}});return React.useEffect(()=>{e===100&&(console.debug("lets animate"),r.x.start(n))},[e]),React.useEffect(()=>(console.debug("mounting"),()=>{console.debug("unmounting")}),[]),useFrame(()=>{r.x.isAnimating&&(t.position.setZ(r.x.get()),t.position.setY(.4*Math.pow(r.x.get()-n,1)),t.updateProjectionMatrix()),t.zoom!==ZOOM&&(t.zoom=ZOOM,t.updateProjectionMatrix())}),jsx(PerspectiveCamera,{"position-z":o,makeDefault:!0,fov:25})},LoaderCubey=React.memo(({visible:e,theme:t})=>{const o=useGLTF(cubeySrc);console.debug(o,"cubey");const n=reactExports.useRef(),r=e?-.3:10,s=getDarkenedColor(t.accent.c,.8),a={"upper-body":new Color(t.mod.c),"lower-body":new Color(t.mod.t),accent:new Color(s),bowtie:new Color(s)};return o.scene.children.forEach(i=>{const c=i.name.split("_")[0],l=a[c];l&&(i.material.color=l)}),useFrame(({clock:i})=>{e&&(n.current.rotation.z=Math.sin(i.elapsedTime)*(Math.PI/40),n.current.rotation.y=Math.PI+Math.sin(.6*i.elapsedTime)*(Math.PI/16),n.current.position.y=r+.2*Math.sin(i.elapsedTime))}),jsx(Fragment,{children:jsx("group",{scale:.6,position:[0,r,-19],children:jsx(PresentationControls,{enabled:!0,global:!0,snap:!0,speed:1,zoom:1,rotation:[0,0,0],polar:[-Math.PI/3,Math.PI/3],config:{mass:2,tension:200,friction:14},children:jsx("group",{ref:n,children:jsx("primitive",{object:o.scene})})})})})},shallowEqual),UpdateUVMaps=()=>{const e=useGLTF(glbSrc,!0).scene;return reactExports.useEffect(()=>{Object.values(e.children).forEach(t=>{if(t.isGroup)return;const o=t,n=1/2.6,r=o.geometry,{min:s}=r.boundingBox,a=19.05,i=.445,c=o.geometry.attributes.position;o.geometry.attributes.uv||o.geometry.setAttribute("uv",new BufferAttribute(new Float32Array(c.count*2),2,!1));const l=o.geometry.attributes.uv,d=new Float32Array(l.count*2);for(let u=0;u<o.geometry.attributes.uv.count;u++)d[2*u]=n*(c.array[u*3]-s.x+i)/a,d[2*u+1]=n*(c.array[u*3+1]-s.y+i)/a;l.copyArray(d),r.center(),l.needsUpdate=!0})},[e]),null};useGLTF.preload(cubeySrc,!0,!0);useGLTF.preload(glbSrc,!0,!0);const KeyboardBG$1=React.memo(e=>{const{onClick:t,visible:o,color:n}=e;return jsxs("mesh",{receiveShadow:!0,position:[0,-5.75,0],rotation:[-Math.PI/2+Math.PI/14,0,0],onClick:t,visible:o,children:[jsx("planeGeometry",{args:[100,100]}),jsx("meshStandardMaterial",{color:n})]})},shallowEqual),CanvasRouter$1=({height:e=500})=>jsx(reactExports.Suspense,{fallback:null,children:jsx(LazyRouter,{height:e})}),LazyRouter=React.lazy(async()=>(await document.fonts.load("bold 16px Fira Sans").finally(),{default:NonSuspenseCanvasRouter})),NonSuspenseCanvasRouter=({height:e=500})=>{const[t]=useLocation(),o=reactExports.useRef(document.body),n=reactExports.useRef(null),r=useAppSelector(getLoadProgress),{progress:s}=useProgress(),a=useAppDispatch(),i=useSize(o),c=Object.values(useAppSelector(getCustomDefinitions)),l=useAppSelector(getSelectedDefinition),d=useAppSelector(getDesignDefinitionVersion),u=useAppSelector(getSelectedTheme),C=reactExports.useMemo(()=>u[dist.KeyColorType.Accent].c,[u]),_=t==="/"&&(!l||r!==1);useGLTF(glbSrc,!0,!0);const h=reactExports.useMemo(()=>c.filter(b=>b[d]),[c,d]),p=t==="/design"&&!h.length,K=t==="/"&&(!l||(r+s/100)/2!==1),y=reactExports.useCallback(()=>{a(updateSelectedKey(null))},[a]),g="hid"in navigator||OVERRIDE_HID_CHECK,m=!g||["/settings","/errors"].includes(t)||p||K,S=useAppSelector(getConfigureKeyboardIsSelectable),M=_;return jsx(Fragment,{children:jsx("div",{style:{height:e,width:"100%",top:0,transform:m?M?i?`translateY(${-300+i.height/2}px)`:"":"translateY(-500px)":"",position:m&&!M?"absolute":"relative",overflow:"visible",zIndex:0,visibility:m&&!M?"hidden":"visible"},ref:n,children:jsxs(Canvas,{flat:!0,shadows:!0,style:{overflow:"visible"},children:[jsx(UpdateUVMaps,{}),jsx(Lights,{}),jsx(KeyboardBG$1,{onClick:y,color:C,visible:!M}),jsx(OrbitControls,{enabled:!1}),jsx(Camera,{}),jsx(LoaderCubey,{theme:u,visible:M&&!l}),jsx(Html,{center:!0,position:[0,M?l?0:-1:10,-19],children:g?l?jsx(Fragment,{children:jsx("div",{style:{textAlign:"center",color:"var(--color_accent)",fontSize:60},children:jsx(FontAwesomeIcon,{spinPulse:!0,icon:faSpinner})})}):jsxs(AccentButtonLarge,{onClick:()=>a(reloadConnectedDevices()),style:{width:"max-content"},children:["Authorize device",jsx(FontAwesomeIcon,{style:{marginLeft:"10px"},icon:faUnlock})]}):null}),jsx(KeyboardGroup$1,{containerRef:n,configureKeyboardIsSelectable:S,loadProgress:r})]})})})},Lights=React.memo(()=>{const s=reactExports.useRef(null);reactExports.useEffect(()=>{s.current&&(s.current.shadow.mapSize.width=2048,s.current.shadow.mapSize.height=2048)},[s.current]);const a=React.useMemo(()=>{const i=new Object3D;return i.position.set(0,0,-19),i.updateMatrixWorld(),i},[]);return jsxs(Fragment,{children:[jsx("ambientLight",{intensity:.8}),jsx(SpotLight,{ref:s,distance:12+3,position:[0,12,-19+2],angle:Math.PI/5,attenuation:5,target:a,intensity:10,castShadow:!0,anglePower:5}),jsx("pointLight",{position:[2,.25,-16],intensity:20}),jsx("pointLight",{position:[-2,.25,-16],intensity:20})]})},shallowEqual),getRouteX$1=e=>{switch(e){case"/debug":return-60;case"/design":return-40;case"/test":return-20;case"/":return 0;default:return-60}},KeyboardGroup$1=React.memo(e=>{const{loadProgress:t,configureKeyboardIsSelectable:o}=e,[n]=useLocation(),r=getRouteX$1(n),s=useSpring({config:config.stiff,x:r}),a=useSize(e.containerRef);return jsx(animated.group,{"position-x":s.x,children:jsx(Keyboards$1,{configureKeyboardIsSelectable:o,loadProgress:t,dimensions:a})})},shallowEqual),Keyboards$1=React.memo(e=>{const{loadProgress:t,dimensions:o,configureKeyboardIsSelectable:n}=e,r=-getRouteX$1("/test"),s=-getRouteX$1("/design"),a=-getRouteX$1("/debug");return jsxs(Fragment,{children:[jsx("group",{visible:t===1,children:jsx(ConfigureKeyboard,{dimensions:o,selectable:n,nDimension:"3D"})}),jsx("group",{"position-x":r,children:jsx(Test,{dimensions:o,nDimension:"3D"})}),jsx("group",{"position-x":s,children:jsx(Design,{dimensions:o,nDimension:"3D"})}),jsx("group",{"position-x":a})]})},shallowEqual),KeyboardBG=styled.div`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
`,KeyboardRouteGroup=styled.div`
  ...
  align-items: center;
  justify-content: center;
`,CanvasRouter=({height:e=500})=>{const[t]=useLocation(),o=reactExports.useRef(document.body),n=reactExports.useRef(null),r=useAppSelector(getLoadProgress),{progress:s}=useProgress(),a=useAppDispatch(),i=useSize(n),c=useSize(o),l=Object.values(useAppSelector(getCustomDefinitions)),d=useAppSelector(getSelectedDefinition),u=useAppSelector(getDesignDefinitionVersion),C=useAppSelector(getSelectedTheme),_=reactExports.useMemo(()=>C[dist.KeyColorType.Accent].c,[C]),h=t==="/"&&(!d||r!==1),p=reactExports.useMemo(()=>l.filter(f=>f[u]),[l,u]),K=t==="/design"&&!p.length,y=t==="/"&&(!d||(r+s/100)/2!==1),g=reactExports.useCallback(()=>{a(updateSelectedKey(null))},[a]),S=!("hid"in navigator||OVERRIDE_HID_CHECK)||["/settings","/errors"].includes(t)||K||y,M=useAppSelector(getConfigureKeyboardIsSelectable),b=h;return jsx(Fragment,{children:jsx("div",{style:{height:e,width:"100%",top:0,transform:S?b?c?`translateY(${-300+c.height/2}px)`:"":"translateY(-500px)":"",position:S&&!b?"absolute":"relative",overflow:"visible",zIndex:2,visibility:S&&!b?"hidden":"visible"},onClick:f=>{f.target.nodeName!=="CANVAS"&&a(clearSelectedKey())},ref:n,children:S?null:jsxs(Fragment,{children:[jsx(KeyboardBG,{onClick:g,$color:_,$visible:!b}),jsx(KeyboardGroup,{containerDimensions:i,configureKeyboardIsSelectable:M,loadProgress:r})]})})})},getRouteX=e=>{switch(e){case"/debug":return-300;case"/design":return-200;case"/test":return-100;case"/":return 0;default:return-300}},KeyboardGroupContainer=styled.div`
  z-index: 2;
  display: block;
  white-space: nowrap;
  height: 100%;
...
`,Routes=()=>{const e="hid"in navigator||OVERRIDE_HID_CHECK,t=useAppSelector(getRenderMode),o=reactExports.useMemo(()=>PANES.map(a=>jsx(Route,{component:a.component,path:a.path},a.key)),[]),n=t==="2D"?CanvasRouter:CanvasRouter$1,r=reactExports.useState({clearTestKeys:()=>{}}),s="/via-col-vento-dev";return jsx(Fragment,{children:jsxs(TestContext.Provider,{value:r,children:[jsx(GlobalStyle,{}),jsxs(Router,{base:s,children:[e&&jsx(UnconnectedGlobalMenu,{}),jsx(n,{height:700}),jsx(Home,{hasHIDSupport:e,children:o})]})]})})},Root=()=>jsx(Provider_default,{store,children:jsx(Routes,{})}),elem=document.getElementById("root");elem&&(createRoot(elem).render(jsx(Root,{})),document.documentElement.dataset.themeMode=getThemeModeFromStore(),updateCSSVariables(getThemeNameFromStore()));
